...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("wsgif"))
    : typeof define === "function" && define.amd
    ? define(["exports", "wsgif"], factory)
    : ((global = global || self), factory((global.dat = {}), global.SuperGif));
})(this, function (exports, SuperGif) {
  "use strict";

  SuperGif = SuperGif && Object.prototype.hasOwnProperty.call(SuperGif, "default") ? SuperGif["default"] : SuperGif;
  ...
  var Controller = (function () {
    ...
    _proto.setDropHandler = function setDropHandler(handler) {
  ...
  var ArrayController$1 = (function (_Controller) {
    _inheritsLoose(ArrayController, _Controller);
    function ArrayController(object, property) {
      var _this2;
  ...
  var ColorController = (function (_Controller) {
    ...
    function ColorController(object, property) {
      ...
      dom.bind(_this2.__saturation_field, "mousedown", fieldDown, false, false);
      dom.bind(_this2.__saturation_field, "touchstart", fieldDown, false, false);
      dom.bind(_this2.__field_knob, "mousedown", fieldDown, false, false);
      dom.bind(_this2.__field_knob, "touchstart", fieldDown, false, false);
      ...
      dom.bind(_this2.__hue_field, "mousedown", fieldDownH, false, false);
      dom.bind(_this2.__hue_field, "touchstart", fieldDownH, false, false);
      function fieldDown(e) {
        setSV(e);
      ...
      function setSV(e) {
        ...
        }
        {
          ...
          var _s = (clientX - fieldRect.left) / (fieldRect.right - fieldRect.left);
          var _v = 1 - (clientY - fieldRect.top) / (fieldRect.bottom - fieldRect.top);
        }
        if (v > 1) {
          v = 1;
        } else if (v < 0) {
      ...
      function setH(e) {
        ...
        }
        {
          ...
          var _h2 = 1 - (clientY - fieldRect.top) / (fieldRect.bottom - fieldRect.top);
        }
        if (h > 1) {
          h = 1;
        } else if (h < 0) {
  ...
  var NumberControllerBox = (function (_NumberController) {
    ...
    function NumberControllerBox(object, property, params) {
      ...
      dom.bind(_this2.__input, "wheel", onWheel, false, false);
  ...
  var NumberControllerSlider = (function (_NumberController) {
    ...
    function NumberControllerSlider(object, property, min, max, step, enumeration) {
      var _this2;
      _this2 =
      ...
      _this2.__label = document.createElement("div");
      ...
      if (enumeration) {
        _this2.enumeration = getEnumArr(enumeration);
      }
      _this2.__label.style.visibility = enumeration ? "visible" : "hidden";
      ...
      _this2.__background.appendChild(_this2.__label);
  ...
  var PlotterController = (function (_Controller) {
    ...
    function PlotterController(object, property, params) {
      ...
      _this.period = typeof params.period === "number" ? params.period : params.period ? 500 : 0;
  ...
  var Vec3Controller = (function (_NumberController) {
    ...
    function Vec3Controller(object, property, params) {
      ...
      _this2.yInput = document.createElement("input");
      _this2.yInput.setAttribute("type", "number");
      _this2.zInput = document.createElement("input");
      _this2.zInput.setAttribute("type", "number");
      dom.bind(_this2.xInput, "change", onChange(xInput));
      dom.bind(_this2.xInput, "blur", onBlur(xInput));
      dom.bind(_this2.xInput, "mousedown", onMouseDown);
      dom.bind(_this2.xInput, "keydown", function (e) {
        if (e.keyCode === 13) {
          _this.__truncationSuspended = true;
          this.blur();
          _this.__truncationSuspended = false;
      ...
      dom.bind(_this2.yInput, "change", onChange(yInput));
      dom.bind(_this2.yInput, "blur", onBlur(yInput));
      dom.bind(_this2.yInput, "mousedown", onMouseDown);
      dom.bind(_this2.yInput, "keydown", function (e) {
        if (e.keyCode === 13) {
          _this.__truncationSuspended = true;
          this.blur();
          _this.__truncationSuspended = false;
      ...
      dom.bind(_this2.zInput, "change", onChange(zInput));
      dom.bind(_this2.zInput, "blur", onBlur(zInput));
      dom.bind(_this2.zInput, "mousedown", onMouseDown);
      dom.bind(_this2.zInput, "keydown", function (e) {
        if (e.keyCode === 13) {
          _this.__truncationSuspended = true;
          this.blur();
          _this.__truncationSuspended = false;
      ...
      _this2.updateDisplay(_this2.xInput);
      _this2.updateDisplay(_this2.yInput);
      _this2.updateDisplay(_this2.zInput);
      _this2.domElement.appendChild(_this2.xInput);
      _this2.domElement.appendChild(_this2.yInput);
      _this2.domElement.appendChild(_this2.zInput);
      return _this2;
    }
    var _proto = Vec3Controller.prototype;
    _proto.updateDisplay = function updateDisplay(whichInput) {
      this[whichInput].value = this.__truncationSuspended
        ? this.getValue()
        : roundToDecimal$1(this.getValue(), this.__precision);
      return _NumberController.prototype.updateDisplay.call(this);
    };
  ...
  var controllerFactory = function controllerFactory(object, property) {
    ...
    if (Common.isArray(initialValue)) {
      return new ArrayController$1(object, property);
    }
  ...
  var ImageFileController = (function (_Controller) {
    _inheritsLoose(ImageFileController, _Controller);
    function ImageFileController(object, property) {
      var _this2;
    ...
    var _proto = ImageFileController.prototype;
    _proto.updateDisplay = function updateDisplay() {
  ...
  var GUI = (function () {
    ...
    _proto.addHifiColor = function addHifiColor(object, property) {
      return _add(this, object, property, {
        hifiColor: true,
      });
    };
    _proto.addVec3 = function addVec3(object, property) {
      return _add(this, object, property, {
        vec3: true,
      });
    };
    _proto.addQuat = function addQuat(object, property) {
      return _add(this, object, property, {
        quat: true,
      });
    };
  ...
  function _add(gui, object, property, params) {
    ...
    if (object instanceof Controller) {
      ...
      if (FoundController) {
        ...
        controller = _construct(ImageController, [object, property].concat(params.factoryArgs));
  ...
  function augmentController(gui, li, controller) {
    ...
    if (controller instanceof NumberControllerSlider) {
      ...
      controller.updateDisplay();
    } else if (controller instanceof ArrayController$1) {
      controller.updateDisplay = Common.compose(function (val) {
  ...
  var controllers = {
    Controller: Controller,
    Array1Controller: ArrayController,
