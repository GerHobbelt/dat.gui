      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        Color.recalculateRGB = function(color, component, componentHexIndex) {
          if (color.__state.space === "HEX") {
            ...
            _common2.default.extend(
              color.__state,
              _math2.default.hsv_to_rgb(color.__state.h, color.__state.s, color.__state.v)
            );
          } else {
          ...
          // Objects
          {
            ...
            conversions: {
              RGBA_OBJ: {
                read: function read(original) {
                  if (
                    _common2.default.isNumber(original.r) &&
                    _common2.default.isNumber(original.g) &&
                    _common2.default.isNumber(original.b) &&
                    _common2.default.isNumber(original.a)
                  ) {
                    return {
                      space: "RGB",
                      r: original.r,
              ...
              HSVA_OBJ: {
                read: function read(original) {
                  if (
                    _common2.default.isNumber(original.h) &&
                    _common2.default.isNumber(original.s) &&
                    _common2.default.isNumber(original.v) &&
                    _common2.default.isNumber(original.a)
                  ) {
                    return {
                      space: "HSV",
          ...
          ColorController.prototype.updateDisplay = function updateDisplay() {
            ...
            if (i !== false) {
              ...
              _common2.default.each(
                _Color2.default.COMPONENTS,
                function(component) {
                  if (
                    !_common2.default.isUndefined(i[component]) &&
                    !_common2.default.isUndefined(this.__color.__state[component]) &&
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function augmentController(gui, li, controller) {
          ...
          if (controller instanceof _NumberControllerSlider2.default) {
            ...
            controller.min = _common2.default.compose(
              r,
              controller.min
            );
            controller.max = _common2.default.compose(
              r,
              controller.max
            );
            ...
            controller.updateDisplay = _common2.default.compose(
              function(val) {
          ...
          controller.setValue = _common2.default.compose(
            function(val) {
