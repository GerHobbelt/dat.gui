	...
	var OptionController = function (_Controller) {
	  ...
	  OptionController.prototype.updateDisplay = function updateDisplay() {
	    if (_dom2.default.isActive(this.__select)) {
            ...
            return this; // prevent number from updating if user is trying to manually update
        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberControllerBox = function (_NumberController) {
	  ...
	  NumberControllerBox.prototype.updateDisplay = function updateDisplay() {
	    this.__input.value = this.getValue().toFixed(7);//this.__truncationSuspended ? this.getValue() : roundToDecimal(this.getValue(), this.__precision).toFixed(this.__precision);
