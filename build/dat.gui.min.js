...
!(function(e, t) {
  ...
  var r,
    ...
    p = (((l = c.prototype).toString = function() {
      return t(this);
    }),
  ...
  (p.recalculateRGB = function(e, t, n) {
    if ("HEX" === e.__state.space) e.__state[t] = u.component_from_hex(e.__state.hex, n);
      ...
      h.extend(e.__state, u.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v));
    }
  }),
  ...
  var b,
    ...
    (b.setValue = function(e) {
      var t = this.__transformOutput(e);
      return (
        (this.object[this.property] = t), this.__onChange && this.__onChange.call(this, t), this.updateDisplay(), this
      );
    }),
    (b.getValue = function() {
  ...
  var S,
    k = {
      ...
      fakeEvent: function(e, t, n, i) {
        ...
        h.defaults(s, i), e.dispatchEvent(s);
      },
      bind: function(e, t, n, i, o) {
        var r = i || !1,
          s = o || !1;
        if (e.addEventListener) {
          var a = h.supportsPassive() ? { capture: r, passive: s } : r;
    ...
    O = (function(a) {
      ...
      return (
        ...
        (t.updateDisplay = function() {
          return k.isActive(this.__select) && !this.forceUpdateDisplay
            ? this
  ...
  function B(e, t, n) {
    var i;
    (i = V.call(this, e, t, n) || this).__truncationSuspended = !1;
    var o,
      r = w(i);
    function s() {
    ...
    function l() {
      k.unbind(window, "mousemove", a), k.unbind(window, "mouseup", l), s();
    }
    return (
      ...
      k.bind(i.__up, "mousedown", function() {
        r.setValue(r.getValue() + r.__impliedStep);
      }),
      k.bind(i.__down, "mousedown", function() {
        r.setValue(r.getValue() - r.__impliedStep);
      }),
      k.bind(
        i.__input,
        ...
        function() {
          ...
          h.isNaN(e) || r._readonly || r.setValue(e);
        },
        !1,
        !0
      ),
  ...
  function j(e, t, n, i, o) {
    var r,
      s = w((r = F.call(this, e, t, { min: n, max: i, step: o }) || this));
    function a(e) {
      e.preventDefault();
      var t = s.__background.getBoundingClientRect();
      return s._readonly || s.setValue(D(e.clientX, t.left, t.right, s.__min, s.__max)), !1;
    }
    function l() {
    ...
    function d(e) {
      ...
      s._readonly || s.setValue(D(t, n.left, n.right, s.__min, s.__max));
    }
    function u() {
    ...
    return (
      ...
      k.bind(
        ...
        function(e) {
          ...
          k.bind(window, "touchmove", d, !1, !0), k.bind(window, "touchend", u, !1, !0), d(e);
        },
        !1,
        !0
      ),
      k.bind(r.__background, "wheel", function(e) {
        e.preventDefault();
        var t = -e.deltaY >> 10 || 1;
  ...
  function X(e, t) {
    var n;
    ((n = z.call(this, e, t) || this).__color = new p(n.getValue())), (n.__temp = new p(0));
    var a = w(n);
    ...
    function o(e) {
      c(e),
        ...
        k.bind(window, "mouseup", s, !1, !0),
        k.bind(window, "touchend", s, !1, !0);
    }
    function r(e) {
      _(e),
    ...
    return (
      ...
      k.bind(n.__saturation_field, "mousedown", o),
      k.bind(n.__saturation_field, "touchstart", o),
      k.bind(n.__field_knob, "mousedown", o),
      k.bind(n.__field_knob, "touchstart", o),
  ...
  function q(e, t) {
    var n,
      i = w((n = W.call(this, e, t) || this));
    return (
      (n.__input = document.createElement("input")),
      n.__input.setAttribute("type", "file"),
      k.bind(n.__input, "change", function(e) {
  ...
  function $(n, i, o) {
    ...
    return (
      (_.font = "bold " + 9 * s + "px Helvetica,Arial,sans-serif"),
      (_.textBaseline = "top"),
      (_.fillStyle = i),
      _.fillRect(0, 0, e, t),
      (_.fillStyle = n),
      ...
      _.fillRect(a, l, d, u),
      {
        ...
        update: function(e, t) {
          (_.globalAlpha = 1),
            (_.fillStyle = n),
            _.drawImage(c, a + s, l, d - s, u, a, l, d - s, u),
            _.fillRect(a + d - s, l, s, u),
            (_.fillStyle = i),
            (_.globalAlpha = 0.9),
            _.fillRect(a + d - s, l, s, r((1 - e / t) * u)),
            "line" === o && _.fillRect(a + d - s, r((1 - e / t) * u) + s + 3, s, r((e / t) * u));
        }
      }
    );
  }
  var Q,
    Z = (y(ee, (Q = v)),
    (ee.prototype.updateDisplay = function() {
      var e = this.getValue();
      return (
  ...
  function ee(e, t, n) {
    var i;
    return (
      ((i = Q.call(this, e, t) || this).max = n.max),
      (i.period = n.period),
      (i.prevValue = i.getValue()),
      (i.lastUpdate = Date.now()),
      (i.__panel = new $(n.fgColor, n.bgColor, n.type)),
  ...
  var oe =
    ...
    re = function(e, t, n, i, o) {
      ...
      return h.isArray(n) || h.isObject(n)
        ...
        : (h.isArray(r) && 3 <= r.length && r.length <= 4) ||
          (h.isObject(r) && r.h && r.s && r.v) ||
          (h.isString(r) && "#" === r[0] && (4 === r.length || 7 === r.length))
        ? new G(e, t)
        : h.isString(r)
        ? new L(e, t)
        : h.isFunction(r)
  ...
  var se,
    ...
    le = (((se = de.prototype).show = function() {
      var e = this;
  ...
  var ue,
    ...
    ge = function t(e) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        (this.__listening = []),
        (i = h.defaults(i, { closeOnTop: !1, autoPlace: !0, width: t.DEFAULT_WIDTH })),
        (i = h.defaults(i, { resizable: i.autoPlace, hideable: i.autoPlace })),
        h.isUndefined(i.load) ? (i.load = { preset: fe }) : i.preset && (i.load.preset = i.preset),
        h.isUndefined(i.parent) && i.hideable && ve.push(this),
        (i.resizable = h.isUndefined(i.parent) && i.resizable),
        i.autoPlace && h.isUndefined(i.scrollable) && (i.scrollable = !0);
      var o,
        r,
        s,
        a = pe && "true" === localStorage.getItem(Se(this, "isLocal"));
      if (
        (Object.defineProperties(this, {
          ...
          useLocalStorage: {
            ...
            set: function(e) {
              pe &&
                ((a = e) ? k.bind(window, "unload", o) : k.unbind(window, "unload", o),
                localStorage.setItem(Se(n, "isLocal"), e));
            }
          }
        }),
        ...
        if (
          ...
          n.useLocalStorage = !0;
          var l = localStorage.getItem(Se(this, "gui"));
        ...
        k.addClass(d, "controller-name"), (r = ye(n, d));
        k.addClass(this.__ul, t.CLASS_CLOSED),
          k.addClass(r, "title"),
          k.bind(r, "click", function(e) {
      ...
      i.autoPlace &&
        (h.isUndefined(i.parent) &&
          (me &&
            ...
            k.addClass(he, "dg"),
            k.addClass(he, t.CLASS_AUTO_PLACE_CONTAINER),
            document.body.appendChild(he),
            (me = !1)),
          he.appendChild(this.domElement),
          k.addClass(this.domElement, t.CLASS_AUTO_PLACE)),
        this.parent || Oe(n, i.width)),
        ...
        i.resizable &&
          (function(t) {
            ...
            function o() {
              k.removeClass(t.__closeButton, ge.CLASS_DRAG),
                k.unbind(window, "mousemove", i),
                k.unbind(window, "mouseup", o);
            }
            function e(e) {
              return (
                e.preventDefault(),
                (n = e.clientX),
                k.addClass(t.__closeButton, ge.CLASS_DRAG),
                k.bind(window, "mousemove", i),
                k.bind(window, "mouseup", o),
                !1
              );
            }
            (t.__resize_handle = document.createElement("div")),
              ...
              k.bind(t.__resize_handle, "mousedown", e),
              k.bind(t.__closeButton, "mousedown", e),
              t.domElement.insertBefore(t.__resize_handle, t.domElement.firstElementChild);
          })(this),
        (o = function() {
          pe &&
            "true" === localStorage.getItem(Se(n, "isLocal")) &&
            localStorage.setItem(Se(n, "gui"), JSON.stringify(n.getSaveObject()));
        }),
  ...
  function xe(e, t, n, i) {
    if (!(t instanceof ne || i.custom || void 0 !== t[n]))
      throw new Error('Object "' + t + '" has no property "' + n + '"');
    var o;
    t[n];
    if (i.color) o = new G(t, n);
    else if (i.plotter) (o = new Z(t, n, i)), e.listen(o);
    else if (i.file) o = new J(t, n);
    else if (t instanceof ne && void 0 === n) o = t;
    else if (t instanceof ne || !i.custom || void 0 !== t[n]) {
      var r = t instanceof ne ? [n].concat(i.factoryArgs) : [t, n].concat(i.factoryArgs);
      o = re.apply(e, r);
    } else o = new ne(t, n);
    i.before instanceof v && (i.before = i.before.__li), Ce(e, o), k.addClass(o.domElement, "c");
    var s =
      i.custom && o instanceof ne == !1
        ? t instanceof ne
          ? t.domElement
          : new ne(t).domElement
        : document.createElement("span");
    i.custom || (s.innerHTML = o.property), k.addClass(s, "property-name");
    var a = document.createElement("div");
    a.appendChild(s), a.appendChild(o.domElement);
    var l = ye(e, a, i.before);
    return (
      k.addClass(l, ge.CLASS_CONTROLLER_ROW),
      o instanceof G
        ? k.addClass(l, "color")
        : o instanceof Z
        ? k.addClass(l, "plotter")
        : o instanceof J
        ? k.addClass(l, "file")
        : k.addClass(l, typeof o.getValue()),
      (function(o, t, r) {
        if (
          ((r.__li = t),
          (r.__gui = o),
          h.extend(r, {
            options: function(e) {
              if (1 < arguments.length) {
                ...
                return r.remove(), xe(o, r.object, r.property, { before: t, factoryArgs: [h.toArray(arguments)] });
              }
              if (h.isArray(e) || h.isObject(e)) {
                var n = r.__li.nextElementSibling;
                return r.remove(), xe(o, r.object, r.property, { before: n, factoryArgs: [e] });
              }
            },
            name: function(e) {
            ...
            listen: function(e) {
              return (r.forceUpdateDisplay = !!e), r.__gui.listen(r), r;
            },
            remove: function() {
          ...
          var i = new H(r.object, r.property, { min: r.__min, max: r.__max, step: r.__step });
          ...
          r instanceof A
            ? (k.bind(t, "click", function() {
                k.fakeEvent(r.__checkbox, "click");
              }),
              k.bind(r.__checkbox, "click", function(e) {
                e.stopPropagation();
              }))
            : r instanceof P
            ? (k.bind(t, "click", function() {
                k.fakeEvent(r.__button, "click");
              }),
              k.bind(t, "mouseover", function() {
                k.addClass(r.__button, "hover");
              }),
              k.bind(t, "mouseout", function() {
                k.removeClass(r.__button, "hover");
              }))
            : r instanceof G
            ? (k.addClass(t, "color"),
              (r.updateDisplay = h.compose(
                function(e) {
                  return (t.style.borderLeftColor = r.__color.toHexString()), e;
                },
                r.updateDisplay
              )),
              r.updateDisplay())
            : r instanceof J && k.addClass(t, "file");
        r.setValue = h.compose(
          function(e) {
            return o.getRoot().__preset_select && r.isModified() && Ee(o.getRoot(), !0), e;
          },
          r.setValue
        );
      })(e, l, o),
  ...
  (ge.CustomController = ne),
    ...
    (ge.TEXT_CLOSED = "Close Controls"),
    (ge.TEXT_OPEN = "Open Controls"),
    (ge._keydownHandler = function(e) {
      "text" === document.activeElement.type || (72 !== e.which && 72 !== e.keyCode) || ge.toggleHide();
    }),
    k.bind(window, "keydown", ge._keydownHandler, !1),
    h.extend(ge.prototype, {
      add: function(e, t) {
        return xe(this, e, t, { custom: e instanceof ne, factoryArgs: Array.prototype.slice.call(arguments, 2) });
      },
      openExportWindow: function(e, t) {
        if (h.isUndefined(ue)) {
          ((ue = new le()).domElement.innerHTML = oe), (_e = document.getElementById("dg-title"));
          var n = ace.require("ace/mode/json").Mode;
          (ce = ace.edit("dg-new-editor")).setTheme("ace/theme/solarized_dark"),
            ce.session.setMode(new n()),
            ce.setReadOnly(!0);
        }
        this.autoPlace && Oe(this, this.width),
          (_e.innerHTML = e),
          ce.setValue(JSON.stringify(t, void 0, 2)),
          ue.show(),
          ce.focus();
      },
      plugins: {
        autocomplete: function(a) {
          var l,
            ...
            _ = a.debounceWaitMs || 0,
            n = t ? "input" : "keyup",
            h = [],
            f = "",
            p = a.minLength,
            m = 0;
          if (!a.input) throw new Error("input undefined");
          var b = a.input;
          function v() {
          ...
          function w() {
            ...
            a.renderGroup && (o = a.renderGroup);
            var r = d.createDocumentFragment(),
              s = "#9?$";
            if (
              (h.forEach(function(t) {
                if (t.group && t.group !== s) {
                  s = t.group;
                  var e = o(t.group, f);
                  e && ((e.className += " group"), r.appendChild(e));
                }
                var n = i(t, f);
                n &&
                  (n.addEventListener("click", function(e) {
                    a.onSelect(t, b), y(), e.preventDefault(), e.stopPropagation();
                  }),
                  t === l && ((n.className += " selected"), "function" == typeof a.onPick && a.onPick(t)),
                  r.appendChild(n));
              }),
              u.appendChild(r),
              h.length < 1)
            ) {
              if (!a.emptyMsg) return void y();
              var e = d.createElement("div");
              (e.className = "empty"), (e.textContent = a.emptyMsg), u.appendChild(e);
            }
            u.parentNode || d.body.appendChild(u),
              (function() {
                if (g()) {
                  (c.height = "auto"), (c.width = b.offsetWidth + "px");
                  var e = b.getBoundingClientRect(),
                    t = e.top + b.offsetHeight,
                  ...
                  n < 0 && (n = 0),
                    ...
                    (c.left = e.left + "px"),
                    (c.maxHeight = n + "px"),
                    a.customize && a.customize(b, e, u, n);
                }
              })(),
              (function() {
              ...
              r.length >= p
                ? (v(),
                  (s = window.setTimeout(function() {
                    a.fetch(r, function(e) {
                      m === o && e && ((f = r), (l = 0 < (h = e).length ? h[0] : void 0), w());
                    });
                  }, _)))
                : y();
            }
          ...
          function C(e) {
            var t = b.value;
            0 === t.length &&
              a.fetch(t, function(e) {
                (f = t), (l = 0 < (h = e).length ? h[0] : void 0), w();
              });
          }
          function x(e) {
          ...
          return (
            (u.className = "autocomplete " + (a.className || "")),
            (c.position = "fixed"),
            b.addEventListener("focus", C),
            b.addEventListener("keydown", x),
            b.addEventListener(n, E),
            b.addEventListener("blur", S),
            window.addEventListener("resize", o),
            d.addEventListener("scroll", r, !0),
            {
              destroy: function() {
                b.removeEventListener("keydown", x),
                  b.removeEventListener("focus", C),
                  b.removeEventListener(n, E),
                  b.removeEventListener("blur", S),
                  window.removeEventListener("resize", o),
                  d.removeEventListener("scroll", r, !0),
                  v(),
                  y(),
                  m++;
              }
      ...
      addColor: function(e, t) {
        return xe(this, e, t, { color: !0 });
      },
      addPlotter: function(e, t, n, i, o, r, s) {
        return xe(this, e, t, {
          plotter: !0,
          max: n || 10,
      ...
      addFile: function(e, t) {
        return xe(this, e, t, { file: !0 });
      },
      addCustomController: function(e, t) {
        return xe(this, e, t, { custom: !0, factoryArgs: Array.prototype.slice.call(arguments, 2) });
      },
      remove: function(e) {
      ...
      destroy: function() {
        ...
        this.autoPlace && he.removeChild(this.domElement);
        var t = this;
        h.each(this.__folders, function(e) {
          t.removeFolder(e);
        }),
          k.unbind(window, "keydown", ge._keydownHandler, !1),
          we(this);
      },
        ...
        if (t.scrollable) {
          ...
          h.each(t.__ul.childNodes, function(e) {
            ...
            t.domElement.clientHeight - 20 < n
              ? (k.addClass(t.domElement, ge.CLASS_TOO_TALL),
                (t.__ul.style.height = t.domElement.clientHeight - 20 + "px"))
              : (k.removeClass(t.domElement, ge.CLASS_TOO_TALL), (t.__ul.style.height = "auto"));
        }
        t.__resize_handle &&
          h.defer(function() {
      ...
      remember: function() {
        if ((h.isUndefined(ue) && ((ue = new le()).domElement.innerHTML = oe), this.parent))
        ...
        h.each(Array.prototype.slice.call(arguments), function(e) {
          0 === t.__rememberedObjects.length &&
            (function(n) {
              ...
              (r.innerHTML = "Revert"), k.addClass(r, "button"), k.addClass(r, "revert");
              var s = document.createElement("span");
              (s.innerHTML = "Delete"), k.addClass(s, "button"), k.addClass(s, "delete");
              ...
              if (
                ...
                (document.getElementById("dg-save-locally").style.display = "block"),
                  "true" === localStorage.getItem(Se(n, "isLocal")) && d.setAttribute("checked", "checked"),
                  Ae(n, l),
                  k.bind(d, "change", function() {
                    (n.useLocalStorage = !n.useLocalStorage), Ae(n, l);
                  });
              }
              var u = document.getElementById("dg-new-constructor");
              k.bind(u, "keydown", function(e) {
                !e.metaKey || (67 !== e.which && 67 !== e.keyCode) || ue.hide();
              }),
                k.bind(t, "click", function() {
                  (u.innerHTML = JSON.stringify(n.getSaveObject(), void 0, 2)), ue.show(), u.focus(), u.select();
                }),
          ...
          this.autoPlace && ((this.width += 40), Oe(this, this.width));
      },
      getRoot: function() {
      ...
      getSaveObject: function() {
        ...
        return (
          ...
          0 < this.__rememberedObjects.length &&
            ((n.preset = this.preset), n.remembered || (n.remembered = {}), (n.remembered[this.preset] = Le(this))),
          (n.folders = {}),
      ...
      saveAs: function(e) {
        this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[fe] = Le(this, !0))),
      ...
      revert: function(t) {
        h.each(
          this.__controllers,
          function(e) {
            this.getRoot().load.remembered ? Ce(t || this.getRoot(), e) : e.setValue(e.initialValue),
      ...
      deleteSave: function() {
        this.preset !== fe &&
          ...
          (this.preset = (function(e) {
            return (
              e.__preset_select.removeChild(e.__preset_select.options[e.__preset_select.selectedIndex]),
  ...
  var Te = { Color: p, math: u, interpret: f },
    Re = {
      Controller: v,
      BooleanController: A,
      OptionController: O,
    ...
    Ve = { GUI: ge },
    He = ge,
    Be = { color: Te, controllers: Re, dom: Ne, gui: Ve, GUI: He };
  (e.GUI = He),
    (e.color = Te),
    (e.controllers = Re),
    (e.default = Be),
