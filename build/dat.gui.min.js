  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      function r(e, t, n) {
        Object.defineProperty(e, t, {
          ...
          set: function(e) {
            "RGB" !== this.__state.space && (h.recalculateRGB(this, t, n), (this.__state.space = "RGB")),
              (this.__state[t] = e);
          }
        });
      }
      function a(e, t) {
        Object.defineProperty(e, t, {
          ...
          set: function(e) {
            "HSV" !== this.__state.space && (h.recalculateHSV(this), (this.__state.space = "HSV")),
              (this.__state[t] = e);
          }
        });
      }
      ...
      (h.recalculateRGB = function(e, t, n) {
        ...
        Object.defineProperty(h.prototype, "hex", {
          get: function() {
            return (
              "HEX" !== !this.__state.space && (this.__state.hex = d.default.rgb_to_hex(this.r, this.g, this.b)),
              this.__state.hex
            );
          },
          set: function(e) {
          ...
          },
          {
            ...
            conversions: {
              ...
              RGB_OBJ: {
                read: function(e) {
                  return (
                    !!(l.default.isNumber(e.r) && l.default.isNumber(e.g) && l.default.isNumber(e.b)) && {
                      space: "RGB",
                      r: e.r,
                      g: e.g,
                      b: e.b
              ...
              HSV_OBJ: {
                read: function(e) {
                  return (
                    !!(l.default.isNumber(e.h) && l.default.isNumber(e.s) && l.default.isNumber(e.v)) && {
                      space: "HSV",
                      h: e.h,
                      s: e.s,
                      v: e.v
          ...
          each: function(e, t, o) {
            if (e)
              if (n && e.forEach && e.forEach === n) e.forEach(t, o);
                ...
                var i = void 0,
                  r = void 0;
                for (i = 0, r = e.length; i < r; i++) if (i in e && t.call(o, e[i], i) === this.BREAK) return;
      ...
      var u = /(\d+(\.\d+)?)px/,
        d = {
          ...
          unbind: function(e, t, n, o) {
            var i = o || !1;
            return (
              e.removeEventListener ? e.removeEventListener(t, n, i) : e.detachEvent && e.detachEvent("on" + t, n), d
            );
          },
          ...
          return (
            ...
            (t.prototype.updateDisplay = function() {
              return d.default.isActive(this.__select)
                ? this
                : ((this.__select.value = this.getValue()), e.prototype.updateDisplay.call(this));
            }),
            t
          );
        })(s.default);
      ...
      var l = n(7),
        ...
        c = (function(e) {
          ...
          return (
            ...
            (t.prototype.updateDisplay = function() {
              return (
                d.default.isActive(this.__input) || (this.__input.value = this.getValue()),
                e.prototype.updateDisplay.call(this)
              );
            }),
            t
          ...
          function t(n, o, a) {
            ...
            return (
              ...
              c.default.isUndefined(s.__step)
                ? 0 === s.initialValue
                  ? (s.__impliedStep = 1)
                  : (s.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(s.initialValue)) / Math.LN10)) / 10)
          ...
          function t(n, o, a, s, u) {
            function d(e) {
              document.activeElement.blur(),
                c.default.bind(window, "mousemove", _),
                c.default.bind(window, "mouseup", b),
                _(e);
            }
            function f(e) {
              document.activeElement.blur(),
                c.default.bind(window, "touchmove", p),
                c.default.bind(window, "touchend", m),
                (y.__activeTouch = e.targetTouches[0]),
                p(e);
            }
            function _(e) {
              h(e.clientX);
            ...
            function p(e) {
              for (var t = e.changedTouches, n = 0; n < t.length; n++)
                t[n].identifier === y.__activeTouch.identifier && h(t[n].clientX);
            }
            function h(e) {
              var t = y.__background.getBoundingClientRect();
              return y.setValue(l(e, t.left, t.right, y.__min, y.__max)), !1;
            }
            function m() {
              c.default.unbind(window, "touchmove", _),
                c.default.unbind(window, "touchend", b),
                (y.__activeTouch = null),
                g();
            }
            function b() {
              c.default.unbind(window, "mousemove", _), c.default.unbind(window, "mouseup", b), g();
            }
            function g() {
              y.__onFinishChange && y.__onFinishChange.call(y, y.getValue());
            }
            i(this, t);
            var v = r(this, e.call(this, n, o, { min: a, max: s, step: u })),
              y = v;
            return (
              (v.__background = document.createElement("div")),
              (v.__foreground = document.createElement("div")),
              c.default.bind(v.__background, "mousedown", d),
              c.default.bind(v.__background, "touchstart", f),
              c.default.addClass(v.__background, "slider"),
              c.default.addClass(v.__foreground, "slider-fg"),
              v.updateDisplay(),
              v.__background.appendChild(v.__foreground),
              v.domElement.appendChild(v.__background),
              v
            );
          }
          return (
        ...
        v = (function(e) {
          function t(n, o) {
            ...
            function b(e) {
              ...
              return (
                n > 1 ? (n = 1) : n < 0 && (n = 0), (y.__color.h = 360 * n), y.setValue(y.__color.toOriginal()), !1
              );
            }
            i(this, t);
            ...
            return (
              ...
              g.default.extend(v.__field_knob.style, {
                ...
                width: "12px",
                height: "12px",
                border: v.__field_knob_border + (v.__color.v < 0.5 ? "#fff" : "#000"),
              ...
              g.default.extend(w.style, { width: "100%", height: "100%", background: "none" }),
    ...
    function(e, t, n) {
      ...
      function a(e, t, n) {
        if (
          ...
          U.default.extend(n, {
            options: function(t) {
              ...
              if (U.default.isArray(t) || U.default.isObject(t)) {
                ...
                return n.remove(), s(e, n.object, n.property, { before: i, factoryArgs: [t] });
              }
            },
            name: function(e) {
          ...
          var o = new B.default(n.object, n.property, { min: n.__min, max: n.__max, step: n.__step });
          ...
          (n.min = U.default.compose(
            i,
            n.min
          )),
            (n.max = U.default.compose(
              i,
              n.max
            ));
        } else
          n instanceof O.default
            ...
            : n instanceof j.default &&
              ...
              (n.updateDisplay = U.default.compose(
                function(e) {
      ...
      function f(e) {
        ...
        if (
          ...
          (f.style.display = "block"),
            "true" === localStorage.getItem(u(e, "isLocal")) && s.setAttribute("checked", "checked"),
            c(e, l),
      ...
      function b(e) {
        0 !== e.length &&
          V.default.call(window, function() {
            b(e);
          }),
      ...
      var Y = "dg",
        ...
        oe = function e(t) {
          ...
          (this.domElement = document.createElement("div")),
            ...
            (this.__listening = []),
            (r = U.default.defaults(r, { closeOnTop: !1, autoPlace: !0, width: e.DEFAULT_WIDTH })),
            (r = U.default.defaults(r, { resizable: r.autoPlace, hideable: r.autoPlace })),
            U.default.isUndefined(r.load) ? (r.load = { preset: Q }) : r.preset && (r.load.preset = r.preset),
            U.default.isUndefined(r.parent) && r.hideable && ne.push(this),
            (r.resizable = U.default.isUndefined(r.parent) && r.resizable),
            r.autoPlace && U.default.isUndefined(r.scrollable) && (r.scrollable = !0);
            ...
            (Object.defineProperties(this, {
              ...
              useLocalStorage: {
                ...
                set: function(e) {
                  q &&
                    ((a = e),
                    e ? z.default.bind(window, "unload", l) : z.default.unbind(window, "unload", l),
          ...
          r.autoPlace &&
            ...
            (l = function() {
              q &&
                ...
                localStorage.setItem(u(o, "gui"), JSON.stringify(o.getSaveObject()));
            }),
      ...
      (oe.toggleHide = function() {
        ...
        U.default.extend(oe.prototype, {
            ...
            if (e.scrollable) {
              ...
              U.default.each(e.__ul.childNodes, function(t) {
                ...
                window.innerHeight - t - W < n
                  ...
                  : (z.default.removeClass(e.domElement, oe.CLASS_TOO_TALL), (e.__ul.style.height = "auto"));
            }
            e.__resize_handle &&
              U.default.defer(function() {
          ...
          remember: function() {
            if (
              (U.default.isUndefined(Z) && ((Z = new F.default()), (Z.domElement.innerHTML = x.default)), this.parent)
            )
          ...
          getSaveObject: function() {
            ...
            return (
              ...
              this.__rememberedObjects.length > 0 &&
                ((e.preset = this.preset), e.remembered || (e.remembered = {}), (e.remembered[this.preset] = h(this))),
              (e.folders = {}),
          ...
          saveAs: function(e) {
            this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[Q] = h(this, !0))),
    ...
    function(e, t, n) {
      ...
      var i = n(10),
        ...
        g = function(e, t) {
          var n = e[t];
          return b.default.isArray(arguments[2]) || b.default.isObject(arguments[2])
            ? new r.default(e, t, arguments[2])
            : b.default.isNumber(n)
            ? b.default.isNumber(arguments[2]) && b.default.isNumber(arguments[3])
              ...
              : b.default.isNumber(arguments[4])
              ? new l.default(e, t, { min: arguments[2], max: arguments[3], step: arguments[4] })
