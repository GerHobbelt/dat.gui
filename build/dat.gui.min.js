    ...
    function(e, t, n) {
          ...
          U["default"].extend(n, {
            options: function(t) {
              if (arguments.length > 1) {
                ...
                return (
                  n.remove(), s(e, n.object, n.property, { before: o, factoryArgs: [U["default"].toArray(arguments)] })
                );
              }
      ...
      var Y = "dg",
        ...
        oe = function ie(e) {
          ...
          (this.domElement = document.createElement("div")),
            ...
            (this.__listening = []),
            (o = U["default"].defaults(o, { autoPlace: !0, width: ie.DEFAULT_WIDTH })),
            (o = U["default"].defaults(o, { resizable: o.autoPlace, hideable: o.autoPlace })),
            U["default"].isUndefined(o.load) ? (o.load = { preset: Q }) : o.preset && (o.load.preset = o.preset),
          ...
          o.autoPlace &&
            ...
            (a = function() {
              q &&
                ...
                localStorage.setItem(u(n, "gui"), JSON.stringify(n.getSaveObject()));
            }),
      ...
      (oe.toggleHide = function() {
        ...
        U["default"].extend(oe.prototype, {
          ...
          remember: function() {
            if (
              (U["default"].isUndefined(Z) && ((Z = new F["default"]()), (Z.domElement.innerHTML = x["default"])),
              this.parent)
            )
            ...
            (e.prototype.layout = function() {
              (this.domElement.style.left = window.innerWidth / 2 - a["default"].getWidth(this.domElement) / 2 + "px"),
                (this.domElement.style.top =
                  window.innerHeight / 2 - a["default"].getHeight(this.domElement) / 2 + "px");
            }),
            e
          );
        })();
