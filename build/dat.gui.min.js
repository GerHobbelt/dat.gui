!(function(e, t) {
        ...
        if (e.litmus(n))
          return (
            h.each(e.conversions, function(e, t) {
              if (((a = e.read(n)), !1 === s && !1 !== a))
                return ((s = a).conversionName = t), (a.conversion = e), h.BREAK;
            }),
            h.BREAK
          );
      }),
  ...
  var v,
    b = (((v = y.prototype).onChange = function(e) {
    ...
    (v.setValue = function(e) {
      var t = this.object[this.property];
      return (
        (this.object[this.property] = e),
        this.__onChange && this.__onChange.call(this, e, t),
        this.updateDisplay(),
        this
      );
    }),
    ...
    return (
      (t.setValue = function(e) {
        ...
        return (
          ...
          a.prototype.setValue.call(this, t)
        );
      }),
      (t.min = function(e) {
  ...
  function H(e, t, n) {
    ...
    return (
      ...
      A.bind(i.__input, "mousedown", function(e) {
        A.bind(window, "mousemove", l), A.bind(window, "mouseup", d), (o = e.clientY);
      }),
      A.bind(i.__input, r, function(e) {
        var t = a.getValue(),
          n = (e.deltaY || -e.wheelDelta || e.detail) >> 10 || 1;
        e.preventDefault(), n < 0 ? (t += a.__impliedStep) : (t -= a.__impliedStep), a.setValue(t);
      }),
      A.bind(i.__input, "keydown", function(e) {
        13 === e.keyCode && ((a.__truncationSuspended = !0), this.blur(), (a.__truncationSuspended = !1), s());
      }),
      i.updateDisplay(),
  ...
  function U(e, t, n, i, o) {
    var a,
      r = C((a = D.call(this, e, t, { min: n, max: i, step: o }) || this));
    (a.__background = document.createElement("div")),
      (a.__foreground = document.createElement("div")),
      A.bind(a.__background, "mousedown", function(e) {
        document.activeElement.blur(), A.bind(window, "mousemove", l), A.bind(window, "mouseup", d), l(e);
      }),
      A.bind(a.__background, "touchstart", function(e) {
        if (1 !== e.touches.length) return;
        A.bind(window, "touchmove", c), A.bind(window, "touchend", u), c(e);
      });
    var s = /Firefox/i.test(navigator.userAgent) ? "DOMMouseScroll" : "mousewheel";
    function l(e) {
      e.preventDefault();
      var t = r.__background.getBoundingClientRect();
      return r.setValue(M(e.clientX, t.left, t.right, r.__min, r.__max)), !1;
    }
    function d() {
    ...
    function c(e) {
      ...
      r.setValue(M(t, n.left, n.right, r.__min, r.__max));
    }
    function u() {
    ...
    return (
      A.bind(a.__background, s, function(e) {
        var t = r.getValue(),
          n = (e.deltaY || -e.wheelDelta || e.detail) >> 10 || 1;
        e.preventDefault(), document.activeElement.blur(), n < 0 ? (t += r.__impliedStep) : (t -= r.__impliedStep);
        r.setValue(t);
      }),
      A.addClass(a.__background, "slider"),
      A.addClass(a.__foreground, "slider-fg"),
      a.updateDisplay(),
  ...
  function J(e, t) {
    var n;
    ((n = Y.call(this, e, t) || this).__color = new f(n.getValue())), (n.__temp = new f(0));
    var s = C(n);
    ...
    function a(e) {
      _(e),
        ...
        A.bind(window, "touchend", l);
    }
    function r() {
      A.unbind(window, "mousemove", u),
        A.unbind(window, "touchmove", u),
  ...
  function te(o, i) {
                  ...
                  (e.extType = "gce"),
                    (function(e) {
                      ...
                      (e.reserved = t.splice(0, 3)),
                        (e.disposalMethod = Z(t.splice(0, 3))),
                        (e.userInput = t.shift()),
    ...
    !(function() {
      ...
      var t = ee(o.readByte());
      (e.gctFlag = t.shift()),
        (e.colorRes = Z(t.splice(0, 3))),
        (e.sorted = t.shift()),
        (e.gctSize = Z(t.splice(0, 3))),
  ...
  var ne,
    ie = function(e, i) {
      ...
      for (
        !(function() {
          for (var e = 0; e < c; e++) (g[e] = new Uint8Array(1)), (g[e][0] = e);
          (g[c] = new Uint8Array(0)), (g[u] = null);
        })();
        ;
        ...
        } else void 0, (l = 2 + c), g.splice(l, g.length - l), (_ = e + 1), (v = 0);
    ...
    oe = ((function(e) {
      ...
      function(e) {
        ...
        var b,
          ...
          O = d.hasOwnProperty("progressbar_background_color")
            ? d.progressbar_background_color
            : "rgba(255,255,255,0.4)",
          B = d.hasOwnProperty("progressbar_foreground_color") ? d.progressbar_foreground_color : "rgba(255,0,22,.8)",
          L = function() {
            (_ = r), (h = r = a = c = null);
          },
          N = function() {
          ...
          H = function(e) {
            R((l = e).width, l.height);
          },
          M = function(e) {
            D(), L(), (c = e.transparencyGiven ? e.transparencyIndex : null), (a = e.delayTime), (r = e.disposalMethod);
          },
          D = function() {
            if (h) {
          ...
          Y = !1,
          W = function(e) {
            return !(n || ((Y = e || !1), (n = !0), (m = []), L(), (p = h = _ = u = null)));
          };
        return {
          play: U.play,
          pause: U.pause,
          move_relative: U.move_relative,
          move_to: U.move_to,
          get_frames: function() {
            return U.frames();
          },
                  ...
                  200 != this.status && I("xhr - response"),
                    "response" in this ||
                      (this.response = new VBArray(this.responseText)
                        ...
                        .join(""));
                  var e = this.response;
                  e instanceof ArrayBuffer && (e = new Uint8Array(e)), (i = new J(e)), setTimeout(N, 0);
                }),
                (n.onprogress = function(e) {
                  e.lengthComputable && V(e.loaded, e.total, !0);
                }),
                (n.onerror = function() {
                  I("xhr");
                }),
          ...
          load_raw: function(e, t) {
            W(t) && (K || j(), (i = new J(e)), setTimeout(N, 0));
          },
  ...
  var ae = (function(d) {
      function e(e, t, n) {
        ...
        return (
          ...
          (i.__glGif = new oe({ gif: i.__gifImg })),
  ...
  var se,
    le = (w(de, (se = b)),
    (de.prototype.updateDisplay = function() {
  ...
  function de(e, t, n, i) {
    ...
    void 0 === n && (n = [0, 0]),
      void 0 === i && (i = [1, 1]),
      ((o = se.call(this, e, t, { min: n, max: i }) || this).__min = n),
      (o.__max = i),
      (o.__vec = o.getValue()),
      (o.__temp = [0, 0]);
    var s = C(o);
  ...
  var ce,
    ue = function(e, t, n, i, o) {
      var a = e[t];
      return arguments.length <= 3 && (h.isArray(n) || h.isObject(n))
        ? new O(e, t, n)
        : h.isNumber(a)
  ...
  var pe,
    ...
    me = (((pe = ge.prototype).show = function() {
      var e = this;
  ...
  var ve,
    ...
    Se = function t(e) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        h.isUndefined(i.load) ? (i.load = { preset: ye }) : i.preset && (i.load.preset = i.preset),
        h.isUndefined(i.parent) && i.hideable && xe.push(this),
        (i.resizable = h.isUndefined(i.parent) && i.resizable),
        i.autoPlace && h.isUndefined(i.scrollable) && (i.scrollable = !0);
      var o,
        a,
        r,
        s = we && "true" === localStorage.getItem(Le(this, "isLocal"));
      if (
          ...
          useLocalStorage: {
            ...
            set: function(e) {
              we &&
                ...
                localStorage.setItem(Le(n, "isLocal"), e));
            }
          }
        }),
        ...
        if (
          ...
          n.useLocalStorage = !0;
          var l = localStorage.getItem(Le(this, "gui"));
        ...
        A.addClass(d, "controller-name"), (a = ke(n, d));
        A.addClass(this.__ul, t.CLASS_CLOSED),
          A.addClass(a, "title"),
          A.bind(a, "click", function(e) {
      ...
      i.autoPlace &&
        (h.isUndefined(i.parent) &&
          (Ce &&
            ...
            A.addClass(be, "dg"),
            A.addClass(be, t.CLASS_AUTO_PLACE_CONTAINER),
            document.body.appendChild(be),
            (Ce = !1)),
          be.appendChild(this.domElement),
          A.addClass(this.domElement, t.CLASS_AUTO_PLACE)),
        this.parent || Ve(n, i.width)),
        ...
        i.resizable &&
          (function(t) {
            ...
            function o() {
              A.removeClass(t.__closeButton, Se.CLASS_DRAG),
            ...
            function e(e) {
              return (
                e.preventDefault(),
                (n = e.clientX),
                A.addClass(t.__closeButton, Se.CLASS_DRAG),
        ...
        (o = function() {
          we &&
            "true" === localStorage.getItem(Le(n, "isLocal")) &&
            localStorage.setItem(Le(n, "gui"), JSON.stringify(n.getSaveObject()));
        }),
  ...
  function Be(e, t, n, i, o) {
    ...
    else if (o.image) a = new ae(t, n, o.factoryArgs[0]);
    else {
      var r = [t, n].concat(o.factoryArgs);
      a = ue.apply(e, r);
    }
    o.before instanceof b && (o.before = o.before.__li), Oe(e, a), A.addClass(a.domElement, "c");
    var s = document.createElement("span");
    A.addClass(s, "property-name"), (s.innerHTML = null !== i ? i : a.property);
    var l = document.createElement("div");
    l.appendChild(s), l.appendChild(a.domElement);
    var d = ke(e, l, o.before);
    return (
      A.addClass(d, Se.CLASS_CONTROLLER_ROW),
      a instanceof W
        ? A.addClass(d, "color")
        : a instanceof ae
        ? A.addClass(d, "image")
      ...
      (function(o, t, a) {
        if (
          ...
          h.extend(a, {
            options: function(e) {
              if (1 < arguments.length) {
                ...
                return (
                  a.remove(), Be(o, a.object, a.property, a.label, { before: t, factoryArgs: [h.toArray(arguments)] })
                );
              }
              if (h.isArray(e) || h.isObject(e)) {
                var n = a.__li.nextElementSibling;
                return a.remove(), Be(o, a.object, a.property, a.label, { before: n, factoryArgs: [e] });
              }
            },
            name: function(e) {
          ...
          var r = new _e(a.object, a.property, { min: a.__min, max: a.__max, step: a.__step });
          ...
          var e = function(e) {
            if (h.isNumber(a.__min) && h.isNumber(a.__max)) {
              ...
              a.remove();
              var i = Be(o, a.object, a.property, a.label, {
          ...
          a instanceof T
            ...
            ? (A.addClass(t, "color"),
              (a.updateDisplay = h.compose(
                function(e) {
                  return (t.style.borderLeftColor = a.__color.toString()), e;
                },
                a.updateDisplay
              )),
              a.updateDisplay())
            : a instanceof le && A.addClass(t, "vector");
        a.setValue = h.compose(
          function(e) {
            return o.getRoot().__preset_select && a.isModified() && Te(o.getRoot(), !0), e;
          },
          a.setValue
        );
      })(e, d, a),
  ...
  (Se.toggleHide = function() {
    ...
    (Se.CLASS_DRAG = "drag"),
    (Se.CLASS_DISPLAY_NONE = "display-none"),
    (Se.CLASS_LIGHT_THEME = "light-theme"),
    (Se.DEFAULT_WIDTH = 245),
    (Se.TEXT_CLOSED = "Close View Controls"),
    (Se.TEXT_OPEN = "Open View Controls"),
    (Se._keydownHandler = function(e) {
      "text" === document.activeElement.type || (72 !== e.which && 72 !== e.keyCode) || Se.toggleHide();
    }),
    A.bind(window, "keydown", Se._keydownHandler, !1),
    h.extend(Se.prototype, {
      add: function(e, t, n) {
        return Be(this, e, t, n, { factoryArgs: Array.prototype.slice.call(arguments, 3) });
      },
      addColor: function(e, t, n) {
        return Be(this, e, t, n, { color: !0 });
      },
      addImage: function(e, t, n) {
        return Be(this, e, t, n, { factoryArgs: Array.prototype.slice.call(arguments, 2), image: !0 });
      },
      remove: function(e) {
      ...
      destroy: function() {
        ...
        this.autoPlace && be.removeChild(this.domElement);
        var t = this;
        h.each(this.__folders, function(e) {
          t.removeFolder(e);
        }),
          A.unbind(window, "keydown", Se._keydownHandler, !1),
          Ae(this);
      },
      addFolder: function(e) {
        ...
        var n = new Se(t);
        this.__folders[e] = n;
        var i = ke(this, n.domElement);
        return A.addClass(i, "folder"), n;
      },
        ...
        if (t.scrollable) {
          ...
          h.each(t.__ul.childNodes, function(e) {
            ...
            t.domElement.clientHeight - 20 < n
              ? (A.addClass(t.domElement, Se.CLASS_TOO_TALL),
                (t.__ul.style.height = t.domElement.clientHeight - 20 + "px"))
              : (A.removeClass(t.domElement, Se.CLASS_TOO_TALL), (t.__ul.style.height = "auto"));
        }
        t.__resize_handle &&
          h.defer(function() {
      ...
      remember: function() {
        if (
          (h.isUndefined(ve) &&
            ((ve = new me()).domElement.innerHTML =
            ...
            (function(n) {
              ...
              if (
                ...
                (document.getElementById("dg-save-locally").style.display = "block"),
                  "true" === localStorage.getItem(Le(n, "isLocal")) && l.setAttribute("checked", "checked"),
                  Re(n, s),
                  A.bind(l, "change", function() {
                    (n.useLocalStorage = !n.useLocalStorage), Re(n, s);
                  });
              }
              var d = document.getElementById("dg-new-constructor");
              A.bind(d, "keydown", function(e) {
                !e.metaKey || (67 !== e.which && 67 !== e.keyCode) || ve.hide();
              }),
                A.bind(t, "click", function() {
                  (d.innerHTML = JSON.stringify(n.getSaveObject(), void 0, 2)), ve.show(), d.focus(), d.select();
                }),
                A.bind(i, "click", function() {
                  n.save();
                }),
      ...
      getSaveObject: function() {
        ...
        return (
          ...
          0 < this.__rememberedObjects.length &&
            ((n.preset = this.preset), n.remembered || (n.remembered = {}), (n.remembered[this.preset] = Ie(this))),
          (n.folders = {}),
      ...
      saveAs: function(e) {
        this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[ye] = Ie(this, !0))),
      ...
      revert: function(t) {
        h.each(
          this.__controllers,
          function(e) {
            this.getRoot().load.remembered ? Oe(t || this.getRoot(), e) : e.setValue(e.initialValue),
  ...
  var He = { Color: f, math: u, interpret: p },
    Me = {
      Controller: b,
      BooleanController: T,
      OptionController: O,
    ...
    Fe = { GUI: Se },
    Ue = Se,
    Pe = { color: He, controllers: Me, dom: De, gui: Fe, GUI: Ue };
  (e.GUI = Ue),
    (e.color = He),
    (e.controllers = Me),
    (e.default = Pe),
