  ...
  return {
    ...
    extend: function (e) {
      this.each(
        a.call(arguments, 1),
        function (a) {
          for (var d in a) this.isUndefined(a[d]) || (e[d] = a[d]);
        },
        this
      );
      return e;
    ...
    defaults: function (e) {
      this.each(
        a.call(arguments, 1),
        function (a) {
          for (var d in a) this.isUndefined(e[d]) && (e[d] = a[d]);
        },
        this
      );
      return e;
    ...
    compose: function () {
      ...
      return function () {
        for (var c = a.call(arguments), d = e.length - 1; 0 <= d; d--) c = [e[d].apply(this, c)];
        return c[0];
      };
    },
    each: function (a, c, d) {
      if (a)
        if (f && a.forEach && a.forEach === f) a.forEach(c, d);
        else if (a.length === a.length + 0)
          for (var b = 0, t = a.length; b < t && !(b in a && c.call(d, a[b], b) === this.BREAK); b++);
        else for (b in a) if (c.call(d, a[b], b) === this.BREAK) break;
    },
    defer: function (a) {
      setTimeout(a, 0);
    },
    ...
    hasOwnProperty: function (a, c) {
      ...
      try {
        ...
        console.warn('property "' + c + '" is unaccessible in prototype of object', a);
      }
      return c in a && (!(c in d) || b !== a[c]);
    },
  };
})();
...
dat.dom.dom = (function (f) {
  ...
  var c = /(\d+(\.\d+)?)px/,
    d = {
      ...
      fakeEvent: function (b, a, d, c) {
        d = d || {};
        var q = e[a];
        if (!q) throw Error("Event type " + a + " not supported.");
        var m = document.createEvent(q);
        switch (q) {
          case "MouseEvents":
            m.initMouseEvent(
              a,
            ...
            break;
          case "KeyboardEvents":
            q = m.initKeyboardEvent || m.initKeyEvent;
            f.defaults(d, {
              cancelable: !0,
              ctrlKey: !1,
              altKey: !1,
            ...
            break;
          default:
            m.initEvent(a, d.bubbles || !1, d.cancelable || !0);
        }
        f.defaults(m, c);
        b.dispatchEvent(m);
      },
      bind: function (a, c, e, f) {
        a.addEventListener ? a.addEventListener(c, e, f || !1) : a.attachEvent && a.attachEvent("on" + c, e);
        return d;
      },
      unbind: function (a, c, e, f) {
        a.removeEventListener ? a.removeEventListener(c, e, f || !1) : a.detachEvent && a.detachEvent("on" + c, e);
        return d;
      },
      addClass: function (a, c) {
        if (void 0 === a.className) a.className = c;
          ...
          -1 == e.indexOf(c) && (e.push(c), (a.className = e.join(" ").replace(/^\s+/, "").replace(/\s+$/, "")));
        }
        return d;
      },
      removeClass: function (a, c) {
        if (c) {
          if (void 0 !== a.className)
            if (a.className === c) a.removeAttribute("class");
            else {
              var e = a.className.split(/ +/),
                f = e.indexOf(c);
              -1 != f && (e.splice(f, 1), (a.className = e.join(" ")));
            }
...
dat.controllers.OptionController = (function (f, a, e) {
  var c = function (d, b, f) {
    c.superclass.call(this, d, b);
    var n = this;
  ...
  c.superclass = f;
  e.extend(c.prototype, f.prototype, {
    setValue: function (a) {
      a = c.superclass.prototype.setValue.call(this, a);
...
dat.controllers.NumberController = (function (f, a) {
  ...
  var c = function (d, b, f) {
    ...
    this.__precision = e(this.__impliedStep);
  };
  c.superclass = f;
  a.extend(c.prototype, f.prototype, {
    ...
    step: function (a) {
      ...
      this.__precision = e(a);
      return this;
    },
  });
  return c;
})(dat.controllers.Controller, dat.utils.common);
dat.controllers.NumberControllerBox = (function (f, a, e) {
  var c = function (d, b, f) {
    function n() {
      var a = parseFloat(m.__input.value);
      e.isNaN(a) || m.setValue(a);
    }
    function k(a) {
      var b = v - a.clientY;
    ...
    c.superclass.call(this, d, b, f);
    var m = this,
      v;
    this.__input = document.createElement("input");
    this.__input.setAttribute("type", "text");
    a.bind(this.__input, "change", n);
  ...
  e.extend(c.prototype, f.prototype, {
    updateDisplay: function () {
      if (!a.isActive(this.__input)) {
        var d = this.__input,
          b;
        if (this.__truncationSuspended) b = this.getValue();
        else {
          b = this.getValue();
          var e = Math.pow(10, this.__precision);
          b = Math.round(b * e) / e;
        }
        d.value = b;
      }
...
dat.controllers.NumberControllerSlider = (function (f, a, e, c, d) {
  ...
  var t = function (c, d, e, f, v) {
    function u(c) {
      c.preventDefault();
      var d = a.getOffset(g.__background),
        e = a.getWidth(g.__background);
      g.setValue(b(c.clientX, d.left, d.left + e, g.__min, g.__max));
      return !1;
    }
    function x() {
    ...
    t.superclass.call(this, c, d, { min: e, max: f, step: v });
    var g = this;
  ...
  t.superclass = f;
  t.useDefaultStyles = function () {
    e.inject(d);
  };
  c.extend(t.prototype, f.prototype, {
    updateDisplay: function () {
      var a = (this.getValue() - this.__min) / (this.__max - this.__min);
      this.__foreground.style.width = 100 * a + "%";
      return t.superclass.prototype.updateDisplay.call(this);
    },
  });
  return t;
})(
...
dat.controllers.FunctionController = (function (f, a, e) {
  var c = function (d, b, e) {
    c.superclass.call(this, d, b);
    var f = this;
...
dat.controllers.BooleanController = (function (f, a, e) {
  var c = function (d, b) {
    c.superclass.call(this, d, b);
    var e = this;
...
dat.controllers.UndefinedController = (function (f, a, e) {
  var c = function (a, b) {
    c.superclass.call(this, a, b);
    this.__input = document.createElement("input");
    this.__input.setAttribute("type", "text");
    this.__input.setAttribute("disabled", !0);
    this.domElement.appendChild(this.__input);
  };
  c.superclass = f;
  e.extend(c.prototype, f.prototype, {
    updateDisplay: function () {
      this.__onFinishChange &&
        (e.isUndefined(this.object[this.property]) || this.__onFinishChange.call(this.object[this.property]));
      return c.superclass.prototype.updateDisplay.call(this);
    },
  });
  return c;
...
dat.color.interpret = (function (f, a) {
  ...
  return function () {
    ...
    a.each(d, function (d) {
      if (d.litmus(b))
        return (
          a.each(d.conversions, function (d, f) {
            e = d.read(b);
            if (!1 === c && !1 !== e) return (c = e), (e.conversionName = f), (e.conversion = d), a.BREAK;
          }),
          a.BREAK
        );
    });
...
dat.GUI = dat.gui.GUI = (function (f, a, e, c, d, b, t, n, k, q, m, v, u, x, g, l) {
  function w(a, b, h, e) {
    if (!l.hasOwnProperty(b, h)) throw Error("Object " + b + ' has no property "' + h + '"');
    e.color ? (b = new m(b, h)) : ((b = [b, h].concat(e.factoryArgs)), (b = c.apply(a, b)));
    e.before instanceof d && (e.before = e.before.__li);
    I(a, b);
    ...
    e = r(a, f, e.before);
    g.addClass(e, p.CLASS_CONTROLLER_ROW);
    g.addClass(e, typeof b.getValue());
    A(a, e, b);
  ...
  function A(a, c, h) {
    ...
    l.extend(h, {
      options: function (b) {
        if (1 < arguments.length)
          return (
            h.remove(),
            w(a, h.object, h.property, { before: h.__li.nextElementSibling, factoryArgs: [l.toArray(arguments)] })
          );
        if (l.isArray(b) || l.isObject(b))
          return h.remove(), w(a, h.object, h.property, { before: h.__li.nextElementSibling, factoryArgs: [b] });
      },
      name: function (a) {
    ...
    if (h instanceof k) {
      var d = new n(h.object, h.property, { min: h.__min, max: h.__max, step: h.__step });
      l.each(["updateDisplay", "onChange", "onFinishChange"], function (a) {
        var H = h[a],
          b = d[a];
        h[a] = d[a] = function () {
      ...
      var e = function (b) {
        return l.isNumber(h.__min) && l.isNumber(h.__max)
          ? (h.remove(),
            w(a, h.object, h.property, {
              before: h.__li.nextElementSibling,
              factoryArgs: [h.__min, h.__max, h.__step],
            }))
          : b;
      };
      h.min = l.compose(e, h.min);
      h.max = l.compose(e, h.max);
    } else
      h instanceof b
        ...
        : h instanceof m
        ? (g.addClass(c, "color"),
          (h.updateDisplay = l.compose(function (a) {
            c.style.borderLeftColor = h.__color.toString();
            return a;
          }, h.updateDisplay)),
          h.updateDisplay())
        : h instanceof v &&
          (h.__onFinishChange = function (b) {
            h.remove();
            return w(a, h.object, h.property, { before: h.__li.nextElementSibling });
          });
    h.setValue = l.compose(function (b) {
  ...
  function M(a) {
    ...
    a.load && a.load.remembered
      ? l.each(a.load.remembered, function (b, c) {
          F(a, c, c == a.preset);
        })
      : F(a, "Default", !1);
  ...
  function N(a) {
    function b(f) {
      f.preventDefault();
      e = f.clientX;
      g.addClass(a.__closeButton, p.CLASS_DRAG);
  ...
  function C(a, b) {
    var c = {};
    l.each(a.__rememberedObjects, function (d, e) {
      var f = {};
      l.each(a.__rememberedObjectIndecesToControllers[e], function (a, c) {
  ...
  var B,
    ...
    p = function (a) {
      ...
      this.__listening = [];
      a = a || {};
      a = l.defaults(a, { autoPlace: !0, width: p.DEFAULT_WIDTH });
      a = l.defaults(a, { resizable: a.autoPlace, hideable: a.autoPlace });
      l.isUndefined(a.load) ? (a.load = { preset: "Default" }) : a.preset && (a.load.preset = a.preset);
      l.isUndefined(a.parent) && a.hideable && L.push(this);
      a.resizable = l.isUndefined(a.parent) && a.resizable;
      a.autoPlace && l.isUndefined(a.scrollable) && (a.scrollable = !0);
      var d = y && "true" === localStorage.getItem(document.location.href + ".isLocal"),
        e;
      Object.defineProperties(this, {
        ...
        closed: {
          ...
          set: function (b) {
            a.closed = b;
            a.closed ? g.addClass(c.__ul, p.CLASS_CLOSED) : g.removeClass(c.__ul, p.CLASS_CLOSED);
            this.onResize();
            c.__closeButton && (c.__closeButton.innerHTML = b ? p.TEXT_OPEN : p.TEXT_CLOSED);
          },
        },
        load: {
          get: function () {
        ...
        useLocalStorage: {
          ...
          set: function (a) {
            y &&
              ((d = a) ? g.bind(window, "unload", e) : g.unbind(window, "unload", e),
              localStorage.setItem(document.location.href + ".isLocal", a));
          },
        },
      });
      if (l.isUndefined(a.parent)) {
        a.closed = !1;
        g.addClass(this.domElement, p.CLASS_MAIN);
        ...
        this.__closeButton.innerHTML = p.TEXT_CLOSED;
        g.addClass(this.__closeButton, p.CLASS_CLOSE_BUTTON);
        ...
        f = r(c, q);
        g.addClass(this.__ul, p.CLASS_CLOSED);
        g.addClass(f, "title");
      ...
      a.autoPlace &&
        (l.isUndefined(a.parent) &&
          (K &&
            ((z = document.createElement("div")),
            g.addClass(z, "dg"),
            g.addClass(z, p.CLASS_AUTO_PLACE_CONTAINER),
            document.body.appendChild(z),
            (K = !1)),
          z.appendChild(this.domElement),
          g.addClass(this.domElement, p.CLASS_AUTO_PLACE)),
  ...
  l.extend(p.prototype, {
    add: function (a, b) {
      return w(this, a, b, { factoryArgs: Array.prototype.slice.call(arguments, 2) });
    },
    addColor: function (a, b) {
      return w(this, a, b, { color: !0 });
    },
    remove: function (a) {
      this.__ul.removeChild(a.__li);
      var b = this.__listening.indexOf(a);
      0 < b && this.__listening.pop(b);
      this.__controllers.pop(this.__controllers.indexOf(a));
      var c = this;
      l.defer(function () {
        c.onResize();
      });
    ...
    onResize: function () {
      ...
      if (a.scrollable) {
        var b = g.getOffset(a.__ul).top,
          c = 0;
        l.each(a.__ul.childNodes, function (b) {
          (a.autoPlace && b === a.__save_row) || (c += g.getHeight(b));
        });
        window.innerHeight - b - 20 < c
          ? (g.addClass(a.domElement, p.CLASS_TOO_TALL), (a.__ul.style.height = window.innerHeight - b - 20 + "px"))
          : (g.removeClass(a.domElement, p.CLASS_TOO_TALL), (a.__ul.style.height = "auto"));
      }
      a.__resize_handle &&
        l.defer(function () {
    ...
    remember: function () {
      l.isUndefined(B) && ((B = new x()), (B.domElement.innerHTML = a));
      if (this.parent) throw Error("You can only call remember on a top level GUI.");
      var b = this;
      l.each(Array.prototype.slice.call(arguments), function (a) {
        0 == b.__rememberedObjects.length && M(b);
    ...
    getSaveObject: function () {
      ...
      0 < this.__rememberedObjects.length &&
        ((a.preset = this.preset), a.remembered || (a.remembered = {}), (a.remembered[this.preset] = C(this)));
      a.folders = {};
      l.each(this.__folders, function (b, c) {
    ...
    revert: function (a) {
      l.each(
        this.__controllers,
        function (b) {
          this.getRoot().load.remembered ? I(a || this.getRoot(), b) : b.setValue(b.initialValue);
        },
        this
      );
      l.each(this.__folders, function (a) {
        a.revert(a);
      });
      a || E(this.getRoot(), !1);
    },
    listen: function (a) {
      ...
      b && J(this.__listening);
    },
    updateDisplay: function () {
      for (var a in this.__controllers) this.__controllers[a].updateDisplay();
      for (var b in this.__folders) this.__folders[b].updateDisplay();
    },
  });
  return p;
})(
  ...
  (dat.controllers.factory = (function (f, a, e, c, d, b, t, n) {
    return function (k, q, m, v) {
      var u = k[q];
      if (n.isArray(m) || n.isObject(m)) return new f(k, q, m);
      if (n.isNumber(u)) return n.isNumber(m) && n.isNumber(v) ? new e(k, q, m, v) : new a(k, q, { min: m, max: v });
      if (n.isString(u)) return new c(k, q);
      if (n.isFunction(u)) return new d(k, q, "");
      if (n.isBoolean(u)) return new b(k, q);
      if (n.isUndefined(u)) return new t(k, q);
    };
  })(
    dat.controllers.OptionController,
    dat.controllers.NumberControllerBox,
    dat.controllers.NumberControllerSlider,
    (dat.controllers.StringController = (function (f, a, e) {
      var c = function (d, b) {
        function e() {
  ...
  (dat.controllers.ColorController = (function (f, a, e, c, d) {
    function b(a, b, c, e) {
      a.style.background = "";
      d.each(k, function (d) {
        a.style.cssText += "background: " + d + "linear-gradient(" + b + ", " + c + " 0%, " + e + " 100%); ";
      });
    }
    function t(a) {
      a.style.background = "";
    ...
    var n = function (f, m) {
      ...
      function x() {
        var a = c(this.value);
        !1 !== a ? ((r.__color.__state = a), r.setValue(r.__color.toOriginal())) : (this.value = r.__color.toString());
      }
      function g() {
      ...
      function l(b) {
        b.preventDefault();
        var c = a.getWidth(r.__saturation_field),
          d = a.getOffset(r.__saturation_field),
      ...
      function w(b) {
        b.preventDefault();
        var c = a.getHeight(r.__hue_field),
          d = a.getOffset(r.__hue_field);
        b = 1 - (b.clientY - d.top + document.body.scrollTop) / c;
        1 < b ? (b = 1) : 0 > b && (b = 0);
        r.__color.h = 360 * b;
        r.setValue(r.__color.toOriginal());
      ...
      a.bind(this.__input, "keydown", function (a) {
        13 === a.keyCode && x.call(this);
      });
      a.bind(this.__input, "blur", x);
      ...
      d.extend(this.__selector.style, {
        width: "122px",
        height: "102px",
        padding: "3px",
        backgroundColor: "#222",
      ...
      d.extend(this.__hue_knob.style, {
        position: "absolute",
        width: "15px",
        height: "2px",
      ...
      d.extend(this.__saturation_field.style, {
        width: "100px",
        height: "100px",
      ...
      d.extend(A.style, { width: "100%", height: "100%", background: "none" });
      b(A, "top", "rgba(0,0,0,0)", "#000");
      d.extend(this.__hue_field.style, {
        width: "15px",
        height: "100px",
        display: "inline-block",
        border: "1px solid #555",
      ...
      this.__saturation_field.appendChild(A);
    ...
    n.superclass = f;
    d.extend(n.prototype, f.prototype, {
      updateDisplay: function () {
        ...
        if (!1 !== a) {
          ...
          d.each(
            e.COMPONENTS,
            function (b) {
              if (!d.isUndefined(a[b]) && !d.isUndefined(this.__color.__state[b]) && a[b] !== this.__color.__state[b])
                return (f = !0), {};
            },
            this
          );
          f && d.extend(this.__color.__state, a);
        }
        d.extend(this.__temp.__state, this.__color.__state);
        this.__temp.a = 1;
    ...
    dat.controllers.Controller,
    dat.dom.dom,
    (dat.color.Color = (function (f, a, e, c) {
      function d(a, b, c) {
        Object.defineProperty(a, b, {
          ...
          set: function (a) {
            "RGB" !== this.__state.space && (t(this, b, c), (this.__state.space = "RGB"));
            this.__state[b] = a;
          },
        });
      }
      function b(a, b) {
        Object.defineProperty(a, b, {
          ...
          set: function (a) {
            "HSV" !== this.__state.space && (n(this), (this.__state.space = "HSV"));
            this.__state[b] = a;
          },
        });
      }
      function t(b, d, e) {
        if ("HEX" === b.__state.space) b.__state[d] = a.component_from_hex(b.__state.hex, e);
        else if ("HSV" === b.__state.space) c.extend(b.__state, a.hsv_to_rgb(b.__state.h, b.__state.s, b.__state.v));
        else throw "Corrupted color state";
      }
      function n(b) {
        var d = a.rgb_to_hsv(b.r, b.g, b.b);
        c.extend(b.__state, { s: d.s, v: d.v });
        c.isNaN(d.h) ? c.isUndefined(b.__state.h) && (b.__state.h = 0) : (b.__state.h = d.h);
      }
      var k = function () {
      ...
      (dat.color.math = (function () {
        ...
        return {
          ...
          rgb_to_hsv: function (a, e, c) {
            var d = Math.max(a, e, c),
              b = d - Math.min(a, e, c);
            if (0 == d) return { h: NaN, s: 0, v: 0 };
            a = (a == d ? (e - c) / b : e == d ? 2 + (c - a) / b : 4 + (a - e) / b) / 6;
            0 > a && (a += 1);
            return { h: 360 * a, s: b / d, v: d / 255 };
          },
          rgb_to_hex: function (a, e, c) {
            a = this.hex_with_component(0, 2, a);
            a = this.hex_with_component(a, 1, e);
            return (a = this.hex_with_component(a, 0, c));
          },
          component_from_hex: function (a, e) {
            return (a >> (8 * e)) & 255;
          },
          hex_with_component: function (a, e, c) {
            return (c << (f = 8 * e)) | (a & ~(255 << f));
          },
        };
      })()),
      dat.color.toString,
    ...
    e.prototype.hide = function () {
      var a = this,
        d = function () {
          ...
          f.unbind(a.domElement, "webkitTransitionEnd", d);
          f.unbind(a.domElement, "transitionend", d);
          f.unbind(a.domElement, "oTransitionEnd", d);
        };
      f.bind(this.domElement, "webkitTransitionEnd", d);
      f.bind(this.domElement, "transitionend", d);
      f.bind(this.domElement, "oTransitionEnd", d);
