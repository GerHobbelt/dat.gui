...
!(function (e, t) {
  ...
  function f(e) {
    r = !1;
    var n = 1 < arguments.length ? p.toArray(arguments) : e;
    return (
      p.each(d, function (e) {
        if (e.litmus(n))
          return (
            p.each(e.conversions, function (e, t) {
              if (((s = e.read(n)), !1 === r && !1 !== s))
                return ((r = s).conversionName = t), (s.conversion = e), p.BREAK;
            }),
            p.BREAK
          );
      }),
  ...
  var s,
      ...
      },
      {
        ...
        conversions: {
          RGBA_OBJ: {
            read: function (e) {
              return (
                !!(p.isNumber(e.r) && p.isNumber(e.g) && p.isNumber(e.b) && p.isNumber(e.a)) && {
                  space: "RGB",
                  r: e.r,
                  g: e.g,
                  b: e.b,
          ...
          RGB_OBJ: {
            read: function (e) {
              return (
                !!(p.isNumber(e.r) && p.isNumber(e.g) && p.isNumber(e.b)) && { space: "RGB", r: e.r, g: e.g, b: e.b }
              );
            },
            write: function (e) {
          ...
          HSVA_OBJ: {
            read: function (e) {
              return (
                !!(p.isNumber(e.h) && p.isNumber(e.s) && p.isNumber(e.v) && p.isNumber(e.a)) && {
                  space: "HSV",
                  h: e.h,
                  s: e.s,
                  v: e.v,
          ...
          HSV_OBJ: {
            read: function (e) {
              return (
                !!(p.isNumber(e.h) && p.isNumber(e.s) && p.isNumber(e.v)) && { space: "HSV", h: e.h, s: e.s, v: e.v }
              );
            },
            write: function (e) {
    ...
    c = {
      ...
      rgb_to_hsv: function (e, t, n) {
        ...
        return 0 === s
          ? { h: NaN, s: 0, v: 0 }
          : ((i = e === s ? (t - n) / r : t === s ? 2 + (n - e) / r : 4 + (e - t) / r),
            (i /= 6) < 0 && (i += 1),
            { h: 360 * i, s: r / s, v: s / 255 });
      },
    ...
    m =
      ...
      (l.toHexString = function () {
        return t(this, !0);
      }),
      (l.toOriginal = function () {
  ...
  function _(e, t, n) {
    Object.defineProperty(e, t, {
      get: function () {
        return "RGB" === this.__state.space || m.recalculateRGB(this, t, n), this.__state[t];
      },
      set: function (e) {
        "RGB" !== this.__state.space && (m.recalculateRGB(this, t, n), (this.__state.space = "RGB")),
          (this.__state[t] = e);
      },
    });
  }
  function h(e, t) {
    Object.defineProperty(e, t, {
      get: function () {
        return "HSV" === this.__state.space || m.recalculateHSV(this), this.__state[t];
      },
      set: function (e) {
        "HSV" !== this.__state.space && (m.recalculateHSV(this), (this.__state.space = "HSV")), (this.__state[t] = e);
      },
    });
  }
  (m.recalculateRGB = function (e, t, n) {
    if ("HEX" === e.__state.space) e.__state[t] = c.component_from_hex(e.__state.hex, n);
      ...
      p.extend(e.__state, c.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v));
    }
  }),
    (m.recalculateHSV = function (e) {
    ...
    (m.COMPONENTS = ["r", "g", "b", "h", "s", "v", "hex", "a"]),
    _(m.prototype, "r", 2),
    _(m.prototype, "g", 1),
    _(m.prototype, "b", 0),
    h(m.prototype, "h"),
      ...
      get: function () {
        return (
          "HEX" !== this.__state.space &&
            ((this.__state.hex = c.rgb_to_hex(this.r, this.g, this.b)), (this.__state.space = "HEX")),
          this.__state.hex
        );
      },
      set: function (e) {
  ...
  var S,
    k = {
      ...
      fakeEvent: function (e, t, n, i) {
        ...
        p.defaults(r, i), e.dispatchEvent(r);
      },
      bind: function (e, t, n, i, o) {
        ...
        return (
          e.addEventListener
            ? ((s = p.supportsPassive() ? { capture: r, passive: a } : r), e.addEventListener(t, n, s))
      ...
      unbind: function (e, t, n, i) {
        var o = i || !1;
        return e.removeEventListener ? e.removeEventListener(t, n, o) : e.detachEvent && e.detachEvent("on" + t, n), k;
      },
      ...
      getWidth: function (e) {
        ...
        return (
          x(t["border-left-width"]) +
          x(t["border-right-width"]) +
          x(t["padding-left"]) +
          x(t["padding-right"]) +
          x(t.width)
        );
      ...
      getHeight: function (e) {
        var t = getComputedStyle(e);
        return (
          x(t["border-top-width"]) +
          x(t["border-bottom-width"]) +
          x(t["padding-top"]) +
          x(t["padding-bottom"]) +
          x(t.height)
        );
    ...
    O = (function (a) {
      ...
      return (
        ...
        (t.updateDisplay = function (e) {
          return e || !k.isActive(this.__select) || this.forceUpdateDisplay
            ? ((this.__select.value = this.getValue()), a.prototype.updateDisplay.call(this, e))
            : this;
        }),
        e
      );
    ...
    T =
      ...
      (L.prototype.updateDisplay = function () {
        return k.isActive(this.__input) || (this.__input.value = this.getValue()), S.prototype.updateDisplay.call(this);
      }),
      L);
  function L(e, t) {
    ...
    return (
      ...
      k.bind(n.__input, "keyup", o, !1, !0),
      k.bind(n.__input, "change", o, !1, !0),
      k.bind(
        n.__input,
        "blur",
        function () {
  ...
  var H,
    V =
      (y(B, (H = N)),
      (B.prototype.updateDisplay = function (e) {
        return !e && k.isActive(this.__input)
          ? this
          : this.__suspendUpdate
          ? void 0
          : ((this.__input.value = this.__truncationSuspended
              ? this.getValue()
              : ((t = this.getValue()), (n = this.__precision), (i = Math.pow(10, n)), Math.round(t * i) / i)),
            H.prototype.updateDisplay.call(this));
        var t, n, i;
      }),
      B);
  function B(e, t, n) {
    var i = H.call(this, e, t, n) || this;
    ...
    function a(e) {
      var t = o - e.clientY;
      s.setValue(s.getValue() + t * s.__impliedStep), (o = e.clientY);
    }
    function l() {
      k.unbind(window, "mousemove", a), k.unbind(window, "mouseup", l), r();
    }
    return (
      (i.__suspendUpdate = !1),
      (i.__input = document.createElement("input")),
      i.__input.setAttribute("type", "number"),
      k.bind(
        i.__input,
        "focus",
        function () {
          this.__suspendUpdate = !0;
        },
        !1,
        !0
      ),
      k.bind(
        ...
        function () {
          ...
          p.isNaN(e) || s._readonly || s.setValue(e);
        },
        !1,
        !0
      ),
      ...
      k.bind(
        ...
        "mousedown",
        function (e) {
          k.bind(window, "mousemove", a, !1, !0), k.bind(window, "mouseup", l, !1, !0), (o = e.clientY);
        },
        !1,
        !0
      ),
      k.bind(i.__input, "wheel", function (e) {
        e.preventDefault();
        var t = -e.deltaY >> 10 || 1;
      ...
      k.bind(
        ...
        function (e) {
          ...
          switch (e.keyCode) {
            case 13:
              (s.__truncationSuspended = !0), this.blur(), (s.__truncationSuspended = !1), r();
              break;
            case 38:
              var n = s.getValue() + t;
              s.setValue(n);
  ...
  function j(e, t, n, i, o) {
    var s = F.call(this, e, t, { min: n, max: i, step: o }) || this,
      r = w(s);
    function a(e) {
      e.preventDefault();
      var t = r.__background.getBoundingClientRect();
      return r._readonly || r.setValue(D(e.clientX, t.left, t.right, r.__min, r.__max)), !1;
    }
    function l() {
    ...
    function d(e) {
      var t = e.touches[0].clientX,
        n = r.__background.getBoundingClientRect();
      r._readonly || r.setValue(D(t, n.left, n.right, r.__min, r.__max));
    }
    function c() {
      k.unbind(window, "touchmove", d),
        k.unbind(window, "touchend", c),
        r.__onFinishChange && r.__onFinishChange.call(r, r.getValue());
    }
    return (
      (s.__background = document.createElement("div")),
      (s.__foreground = document.createElement("div")),
      k.bind(s.__background, "mousedown", function (e) {
        document.activeElement.blur(), k.bind(window, "mousemove", a), k.bind(window, "mouseup", l, !1, !0), a(e);
      }),
      k.bind(
        s.__background,
        "touchstart",
        function (e) {
          ...
          k.bind(window, "touchmove", d, !1, !0), k.bind(window, "touchend", c, !1, !0), d(e);
        },
        !1,
        !0
      ),
      k.bind(s.__background, "wheel", function (e) {
        e.preventDefault();
        var t = -e.deltaY >> 10 || 1;
  ...
  function U(e, t, n) {
    ...
    return (
      ...
      k.bind(i.__button, "click", function (e) {
        return e.preventDefault(), e.stopPropagation(), o.fire(), !1;
      }),
  ...
  var z,
    G =
      (y(X, (z = g)),
      (X.prototype.updateDisplay = function (e) {
        if (!e && k.isActive(this.__input)) return this;
        var t,
          n = f(this.getValue());
        !1 !== n &&
          ((t = !1),
          p.each(
            m.COMPONENTS,
            function (e) {
              if (!p.isUndefined(n[e]) && !p.isUndefined(this.__color.__state[e]) && n[e] !== this.__color.__state[e])
                return (t = !0), {};
            },
            this
          ),
          ...
          (this.__temp.a = 1);
        var i = this.__color.v < 0.5 || 0.5 < this.__color.s ? 255 : 0,
          o = 255 - i;
        p.extend(this.__field_knob.style, {
          ...
          (this.__temp.s = 1),
          (this.__temp.v = 1),
          Y(this.__saturation_field, "left", "#fff", this.__temp.toHexString()),
      ...
      X);
  function X(e, t) {
    var n = z.call(this, e, t) || this;
    (n.__color = new m(n.getValue())), (n.__temp = new m(0));
    var a = w(n);
    (n.domElement = document.createElement("div")),
      ...
      k.bind(n.__input, "blur", c, !1, !0),
      k.bind(
        n.__selector,
        "mousedown",
        function () {
          k.addClass(this, "drag").bind(window, "mouseup", function () {
            k.removeClass(a.__selector, "drag");
          });
        },
        !1,
        !0
    ...
    function s(e) {
      _(e),
        ...
        k.bind(window, "mouseup", l, !1, !0),
        k.bind(window, "touchend", l, !1, !0);
    }
    function r(e) {
      h(e),
        k.bind(window, "mousemove", h),
        k.bind(window, "touchmove", h),
        k.bind(window, "mouseup", d, !1, !0),
        k.bind(window, "touchend", d, !1, !0);
    }
    function l() {
      k.unbind(window, "mousemove", _),
        k.unbind(window, "touchmove", _),
        k.unbind(window, "mouseup", l),
        k.unbind(window, "touchend", l),
        u();
    }
    function d() {
      k.unbind(window, "mousemove", h),
        k.unbind(window, "touchmove", h),
        k.unbind(window, "mouseup", d),
        k.unbind(window, "touchend", d),
        u();
    }
    function c() {
      var e = f(this.value);
    ...
    return (
      ...
      p.extend(o.style, { width: "100%", height: "100%", background: "none" }),
      Y(o, "top", "rgba(0,0,0,0)", "#000"),
      ...
      k.bind(n.__saturation_field, "mousedown", s),
      k.bind(n.__saturation_field, "touchstart", s),
      k.bind(n.__field_knob, "mousedown", s),
      k.bind(n.__field_knob, "touchstart", s),
      k.bind(n.__hue_field, "mousedown", r),
      k.bind(n.__hue_field, "touchstart", r),
    ...
    return (
      ...
      _.fillRect(a, l, d, c),
      {
        ...
        update: function (e, t) {
          (_.globalAlpha = 1),
            (_.fillStyle = n),
            _.drawImage(u, a + r, l, d - r, c, a, l, d - r, c),
            _.fillRect(a + d - r, l, r, c),
            (_.fillStyle = i),
            (_.globalAlpha = 0.9),
            _.fillRect(a + d - r, l, r, s((1 - e / t) * c)),
            "line" === o && _.fillRect(a + d - r, s((1 - e / t) * c) + r + 3, r, s((e / t) * c));
        },
      }
    );
  }
    ...
    q =
      ...
      ($.prototype.updateDisplay = function () {
        ...
        return (
          ...
          (this.prevValue = e),
          W.prototype.updateDisplay.call(this)
        );
      }),
      $);
  function $(e, t, n) {
    var i = W.call(this, e, t) || this;
    return (
      (n = n || {}),
      (i.max = n.max || 3),
      (i.liClass = n.liClass || "plotter"),
      (i.period = n.period || 0),
      (i.prevValue = i.getValue()),
      (i.lastUpdate = Date.now()),
      (i.__panel = new J(n.fgColor || "#fff", n.bgColor || "#000", n.type || "line")),
  ...
  var Q,
    ...
    ee = function (e, t, n, i, o) {
      var s = e[t];
      return p.isArray(n) || p.isObject(n)
        ? new O(e, t, n)
        : p.isNumber(s)
        ? p.isNumber(n) && p.isNumber(i)
          ? p.isNumber(o)
            ? new M(e, t, n, i, o)
            : new M(e, t, n, i)
          : p.isNumber(o)
        ...
        : (p.isArray(s) && 3 <= s.length && s.length <= 4) ||
          (p.isObject(s) && s.h && s.s && s.v) ||
          (p.isString(s) && "#" === s[0] && (4 === s.length || 7 === s.length))
        ? new G(e, t)
        : p.isString(s)
        ? new T(e, t)
        : p.isFunction(s)
    ...
    te =
      (y(ne, (Q = g)),
      (ne.prototype.updateDisplay = function () {
        var e;
        return (
          this.isModified() && ((e = this.getValue()), (this.__image.src = e), (this.initialValue = e)),
          Q.prototype.updateDisplay.call(this)
        );
      }),
      ne);
  function ne(e, t) {
    var n = Q.call(this, e, t) || this;
    n.__fileReader = new FileReader();
    var i = w(n);
    return (
      (n.__image = document.createElement("img")),
      (n.__imagePreview = document.createElement("img")),
      (n.__input = document.createElement("input")),
      p.extend(n.__imagePreview.style, {
        display: "block",
        width: "calc(100% + 5px)",
        padding: "4px 0",
        marginLeft: "-5px",
      ...
      k.bind(n.__image, "load", function () {
        (i.__imagePreview.src = i.__image.src), i.__onChange && i.__onChange.call(i, i.__image);
      }),
      k.bind(n.__input, "change", function () {
        var e = i.__input.files[0];
        if (!e) return;
        i.__fileReader.readAsDataURL(e);
      }),
      k.bind(n.__fileReader, "loadend", function () {
        i.__image.src = i.__fileReader.result;
      }),
      (n.__image.src = e[t]),
      (n.__imagePreview.src = e[t]),
      (n.__input.type = "file"),
      n.domElement.appendChild(n.__imagePreview),
      n.domElement.appendChild(n.__input),
      n
    );
  }
  var ie,
    ...
    se =
      ...
      (ie.layout = function () {
        (this.domElement.style.left = window.innerWidth / 2 - k.getWidth(this.domElement) / 2 + "px"),
          (this.domElement.style.top = window.innerHeight / 2 - k.getHeight(this.domElement) / 2 + "px");
      }),
      re);
  function re() {
  ...
  var ae,
    ...
    pe = function t(e) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        (this.__listening = []),
        (i = p.defaults(i, { closeOnTop: !1, autoPlace: !0, width: t.DEFAULT_WIDTH })),
        (i = p.defaults(i, { resizable: i.autoPlace, hideable: i.autoPlace })),
        p.isUndefined(i.load) ? (i.load = { preset: de }) : i.preset && (i.load.preset = i.preset),
        p.isUndefined(i.parent) && i.hideable && he.push(this),
        (i.resizable = p.isUndefined(i.parent) && i.resizable),
        i.autoPlace && p.isUndefined(i.scrollable) && (i.scrollable = !0);
      var o,
        s,
        r,
        a,
      ...
      function h() {
        k.unbind(window, "mousemove", _), k.unbind(window, "mouseup", h);
      }
      Object.defineProperties(this, {
        ...
        name: {
          ...
          set: function (e) {
            (i.name = e), n.__closeButton && (n.__closeButton.innerHTML = i.name), s && (s.innerHTML = i.name);
          },
        },
        closed: {
          get: function () {
          ...
          set: function (e) {
            (i.closed = e),
              i.closed ? k.addClass(n.__ul, t.CLASS_CLOSED) : k.removeClass(n.__ul, t.CLASS_CLOSED),
              this.onResize(),
              n.__closeButton &&
                (i.name
                  ? (n.__closeButton.innerHTML = i.name)
        ...
        useLocalStorage: {
          ...
          set: function (e) {
            ce &&
              ((u = e) ? k.bind(window, "unload", o) : k.unbind(window, "unload", o),
        ...
        p.isUndefined(i.parent)
          ? (k.addClass(this.domElement, t.CLASS_MAIN),
            ...
            ce && u && ((n.useLocalStorage = !0), (r = localStorage.getItem(ye(0, "gui"))) && (i.load = JSON.parse(r))),
            (this.__closeButton = document.createElement("div")),
            i.name ? (this.__closeButton.innerHTML = i.name) : (this.__closeButton.innerHTML = t.TEXT_CLOSED),
            ...
            i.closeOnTop
              ...
              : (k.addClass(this.__closeButton, t.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)),
            k.bind(this.__closeButton, "click", function () {
              n.closed = !n.closed;
            }))
          : (void 0 === i.closed && (i.closed = !0),
            (a = document.createTextNode(i.name)),
            k.addClass(a, "controller-name"),
            (s = fe(n, a)),
        ...
        i.resizable &&
          ...
          p.extend(l.__resize_handle.style, {
            width: "6px",
            marginLeft: "-3px",
            height: "200px",
            cursor: "ew-resize",
          ...
          k.bind(l.__resize_handle, "mousedown", function (e) {
            return (
              e.preventDefault(), (d = e.clientX), k.bind(window, "mousemove", _), k.bind(window, "mouseup", h), !1
            );
          }),
  ...
  function me(e) {
    k.unbind(window, "resize", e.__resizeHandler),
      e.saveToLocalStorageIfPossible && k.unbind(window, "unload", e.saveToLocalStorageIfPossible);
  }
  function be(e, t) {
  ...
  function ge(e, t) {
    ...
    if (-1 !== i) {
      ...
      if (
        ...
        s[i] && void 0 !== s[i][t.property] && ((r = s[i][t.property]), (t.initialValue = r), t.setValue(r));
      }
    }
  }
  function ve(e, t, n, i) {
    var o, s;
    if (t instanceof g) (s = t), (i = n || {});
    else {
      ...
      i.color
        ...
        ? (s = new te(t, n))
        : i.plotter
        ? ((s = new q(t, n, i)), e.listen(s))
        : ((o = [t, n].concat(i.factoryArgs)), (s = ee.apply(e, o)));
    }
    i.before instanceof g && (i.before = i.before.__li), ge(e, s), k.addClass(s.domElement, "c");
    var r = document.createElement("span");
    k.addClass(r, "property-name"), (r.innerHTML = s.property);
    var a = document.createElement("div");
    a.appendChild(r), a.appendChild(s.domElement);
    var l,
      d,
      c,
      u,
      ...
      h = fe(e, a, i.before);
    return (
      k.addClass(h, pe.CLASS_CONTROLLER_ROW),
      t.className && k.addClass(h, t.className),
      s instanceof G
        ? k.addClass(h, "color")
        : s instanceof te
        ? k.addClass(h, "image")
        : s instanceof q
        ? k.addClass(h, "plotter")
        : i.liClass
        ? k.addClass(h, i.liClass)
        : s.liClass
        ? k.addClass(h, s.liClass)
        : k.addClass(h, typeof s.getValue()),
      (l = e),
      (d = h),
      ((c = s).__li = d),
      (c.__gui = l),
      p.extend(c, {
        options: function (e) {
          if (1 < arguments.length) {
            ...
            return c.remove(), ve(l, c.object, c.property, { before: t, factoryArgs: [p.toArray(arguments)] });
          }
          if (p.isArray(e) || p.isObject(e)) {
            var n = c.__li.nextElementSibling;
            return c.remove(), ve(l, c.object, c.property, { before: n, factoryArgs: [e] });
          }
        },
        name: function (e) {
      ...
      c instanceof M
        ? ((u = new V(c.object, c.property, { min: c.__min, max: c.__max, step: c.__step })),
          p.each(["updateDisplay", "onChange", "onFinishChange", "step", "min", "max"], function (e) {
            var t = c[e],
              n = u[e];
            c[e] = u[e] = function () {
              var e = Array.prototype.slice.call(arguments);
              return n.apply(u, e), t.apply(c, e);
            };
          }),
          k.addClass(d, "has-slider"),
          c.domElement.insertBefore(u.domElement, c.domElement.firstElementChild))
        : c instanceof V
        ? ((_ = function (e) {
            if (p.isNumber(c.__min) && p.isNumber(c.__max)) {
              var t = c.__li.firstElementChild.firstElementChild.innerHTML,
                n = -1 < c.__gui.__listening.indexOf(c);
              c.remove();
              var i = ve(l, c.object, c.property, {
          ...
          (c.min = p.compose(_, c.min)),
          (c.max = p.compose(_, c.max)))
        : c instanceof A
        ? (k.bind(d, "click", function () {
            k.fakeEvent(c.__checkbox, "click");
          }),
          k.bind(c.__checkbox, "click", function (e) {
            e.stopPropagation();
          }))
        : c instanceof I
        ? (k.bind(d, "click", function () {
            k.fakeEvent(c.__button, "click");
          }),
          k.bind(d, "mouseover", function () {
            k.addClass(c.__button, "hover");
          }),
          k.bind(d, "mouseout", function () {
            k.removeClass(c.__button, "hover");
          }))
        : c instanceof G &&
          (k.addClass(d, "color"),
          (c.updateDisplay = p.compose(function (e) {
            return (d.style.borderLeftColor = c.__color.toHexString()), e;
          }, c.updateDisplay)),
          c.updateDisplay()),
      (c.setValue = p.compose(function (e) {
        return l.getRoot().__preset_select && c.isModified() && be(l.getRoot(), !0), e;
      }, c.setValue)),
  ...
  function xe(o, s) {
    var r = {};
    return (
      p.each(o.__rememberedObjects, function (e, t) {
        var n = {},
  ...
  (pe.toggleHide = function () {
    ...
    k.bind(window, "keydown", pe._keydownHandler, !1),
    p.extend(pe.prototype, {
      add: function (e, t) {
      ...
      addPlotter: function (e, t, n, i, o, s, r) {
        return ve(this, e, t, {
          plotter: !0,
          max: n || 10,
      ...
      destroy: function () {
        ...
        p.each(this.__folders, function (e) {
          ...
          k.unbind(window, "keydown", pe._keydownHandler, !1),
          me(this);
      },
      ...
      onResize: function () {
        ...
        n.scrollable &&
          ...
          window.innerHeight - e - 20 < t
            ? (k.addClass(n.domElement, pe.CLASS_TOO_TALL), (n.__ul.style.height = window.innerHeight - e - 20 + "px"))
            : (k.removeClass(n.domElement, pe.CLASS_TOO_TALL), (n.__ul.style.height = "auto"))),
          n.__resize_handle &&
            p.defer(function () {
      ...
      remember: function () {
        if (
          (p.isUndefined(ae) &&
            ((ae = new se()).domElement.innerHTML =
        ...
        p.each(Array.prototype.slice.call(arguments), function (e) {
          0 === t.__rememberedObjects.length &&
            (function (n) {
              ...
              (o.innerHTML = "New"), k.addClass(o, "button"), k.addClass(o, "save-as");
              var s = document.createElement("span");
              (s.innerHTML = "Revert"), k.addClass(s, "button"), k.addClass(s, "revert");
              var r = document.createElement("span");
              (r.innerHTML = "Delete"), k.addClass(r, "button"), k.addClass(r, "delete");
                ...
                : we(n, de, !1);
              {
                ...
                k.bind(a, "change", function () {
                  ...
                  ce &&
                    ...
                    "true" === localStorage.getItem(ye(0, "isLocal")) && d.setAttribute("checked", "checked"),
                    Ce(n, l),
                    k.bind(d, "change", function () {
                      (n.useLocalStorage = !n.useLocalStorage), Ce(n, l);
                    }));
              }
              var c = document.getElementById("dg-new-constructor");
              k.bind(c, "keydown", function (e) {
                !e.metaKey || (67 !== e.which && 67 !== e.keyCode) || ae.hide();
              }),
                k.bind(t, "click", function () {
                  (c.innerHTML = JSON.stringify(n.getSaveObject(), void 0, 2)), ae.show(), c.focus(), c.select();
                }),
          ...
          this.autoPlace && ((this.width += 40), Ee(this, this.width));
      },
      getRoot: function () {
      ...
      deleteSave: function () {
        ...
        this.preset !== de &&
          ...
          (this.preset =
            ((e = this).__preset_select.removeChild(e.__preset_select.options[e.__preset_select.selectedIndex]),
            e.__preset_select.options[e.__preset_select.selectedIndex].value)),
          this.saveToLocalStorageIfPossible());
      },
      listen: function (e) {
  ...
  var Se = { Color: m, math: c, interpret: f },
    ke = {
      Controller: g,
      BooleanController: A,
      OptionController: O,
    ...
    Ae = { dom: k },
    Oe = { GUI: pe },
    Te = { color: Se, controllers: ke, dom: Ae, gui: Oe, GUI: pe };
  (e.GUI = pe),
    (e.color = Se),
    (e.controllers = ke),
    (e.default = Te),
