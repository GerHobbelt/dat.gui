...
!(function(e, t) {
  ...
  var v,
    g = (((v = y.prototype).onChange = function(e) {
    ...
    (v.setValue = function(e, t) {
      void 0 === t && (t = !1);
      var n = this.object[this.property];
      return (
        (this.object[this.property] = e),
        this.__onChange && !t && this.__onChange.call(this, e, n),
        this.updateDisplay(),
        this
      );
    }),
  ...
  var k,
    ...
    T = (function(a) {
      ...
      return (
        (t.setValue = function(e, t) {
          void 0 === t && (t = !1);
          var n = a.prototype.setValue.call(this, e, t);
    ...
    return (
      (t.setValue = function(e, t) {
        ...
        return (
          ...
          r.prototype.setValue.call(this, n, t)
        );
      }),
      (t.min = function(e) {
  ...
  function F(e, t, n) {
    ...
    function l(e) {
      var t = r - e.clientY;
      s.setValue(s.getValue() + t * s.__impliedStep), (r = e.clientY);
    }
    function d() {
      A.unbind(window, "mousemove", l), A.unbind(window, "mouseup", d), a();
    }
    return (
      (i.__input = document.createElement("input")),
      i.__input.setAttribute("type", "text"),
      A.bind(i.__input, "change", function() {
        var e = s.__input.value;
        n && s.__suffix && (e = e.replace(s.__suffix, ""));
        var t = parseFloat(e);
        _.isNaN(t) || s.setValue(t);
      }),
      A.bind(i.__input, "blur", function() {
        a();
      }),
      A.bind(i.__input, "mousedown", function(e) {
        A.bind(window, "mousemove", l), A.bind(window, "mouseup", d), (r = e.clientY);
      }),
      A.bind(i.__input, "keydown", function(e) {
        13 === e.keyCode && ((s.__truncationSuspended = !0), this.blur(), (s.__truncationSuspended = !1), a());
      }),
      i.updateDisplay(),
  ...
  function I(e, t, n, i, o) {
    var r,
      s = E((r = D.call(this, e, t, { min: n, max: i, step: o }) || this));
    function a(e) {
      d(e.clientX);
    }
    function l(e) {
  ...
  var $,
    ...
    (te.prototype.updateDisplay = function() {
      ...
      (i += ")"),
        _.extend(this.__input.style, { background: i, color: "#fff", textShadow: this.__input_textShadow + " #000" });
    }),
    te);
  function te(e, t, n) {
    var i,
      o = E((i = $.call(this, e, t) || this));
    function r() {
  ...
  var ne,
    ...
    oe = (((ne = re.prototype).show = function() {
      var e = this;
  ...
  var se,
    ...
    he = function t(e) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        _.isUndefined(i.load) ? (i.load = { preset: le }) : i.preset && (i.load.preset = i.preset),
        _.isUndefined(i.parent) && i.hideable && _e.push(this),
        (i.resizable = _.isUndefined(i.parent) && i.resizable),
        i.autoPlace && _.isUndefined(i.scrollable) && (i.scrollable = !0);
      var o,
        r,
        s = de && "true" === localStorage.getItem(ve(this, "isLocal"));
      if (
          ...
          useLocalStorage: {
            ...
            set: function(e) {
              de &&
                ...
                localStorage.setItem(ve(n, "isLocal"), e));
            }
          }
        }),
        ...
        if (
          ((i.closed = !1), A.addClass(this.domElement, t.CLASS_MAIN), A.makeSelectable(this.domElement, !1), de && s)
        ) {
          n.useLocalStorage = !0;
          var a = localStorage.getItem(ve(this, "gui"));
      ...
      i.autoPlace &&
        (_.isUndefined(i.parent) &&
          (ce &&
            ...
            A.addClass(ae, "dg"),
            A.addClass(ae, t.CLASS_AUTO_PLACE_CONTAINER),
            document.body.appendChild(ae),
            (ce = !1)),
          ae.appendChild(this.domElement),
          A.addClass(this.domElement, t.CLASS_AUTO_PLACE)),
        this.parent || we(n, i.width)),
        ...
        i.resizable &&
          (function(t) {
            ...
            function o() {
              A.removeClass(t.__closeButton, he.CLASS_DRAG),
            ...
            function e(e) {
              return (
                e.preventDefault(),
                (n = e.clientX),
                A.addClass(t.__closeButton, he.CLASS_DRAG),
        ...
        (o = function() {
          de &&
            "true" === localStorage.getItem(ve(n, "isLocal")) &&
            localStorage.setItem(ve(n, "gui"), JSON.stringify(n.getSaveObject()));
        }),
    ...
    if (-1 !== i) {
      ...
      if (
        ...
        if (r[i] && void 0 !== r[i][t.property]) {
          ...
          (t.initialValue = a), t.setValue(a, !0);
        }
      }
    }
  }
  function be(e, t, n, i) {
    ...
    else if (i.gradient) o = new ee(t, n, i.factoryArgs[0]);
    else {
      var r = [t, n].concat(i.factoryArgs);
      o = Z.apply(e, r);
    }
    i.before instanceof g && (i.before = i.before.__li), me(e, o), A.addClass(o.domElement, "c");
    var s = document.createElement("span");
    A.addClass(s, "property-name"), (s.innerHTML = o.property);
    var a = document.createElement("div");
    a.appendChild(s), a.appendChild(o.domElement);
    var l = fe(e, a, i.before);
    return (
      A.addClass(l, he.CLASS_CONTROLLER_ROW),
        ...
        if (
          ...
          _.extend(r, {
            options: function(e) {
              if (1 < arguments.length) {
                ...
                return r.remove(), be(o, r.object, r.property, { before: t, factoryArgs: [_.toArray(arguments)] });
              }
              if (_.isArray(e) || _.isObject(e)) {
                var n = r.__li.nextElementSibling;
                return r.remove(), be(o, r.object, r.property, { before: n, factoryArgs: [e] });
              }
            },
            name: function(e) {
          ...
          var e = function(e) {
            if (_.isNumber(r.__min) && _.isNumber(r.__max)) {
              ...
              r.remove();
              var i = be(o, r.object, r.property, {
          ...
          r instanceof O
            ...
            ? (A.addClass(t, "array"),
              (r.updateDisplay = _.compose(
                function() {
                  t.style.height = 26 * (r.__inputs.length + 1) + "px";
                },
                r.updateDisplay
              )),
              r.updateDisplay())
            : r instanceof ee && (t.style.borderLeft = "3px solid #2FA1D6");
        r.setValue = _.compose(
          function(e) {
            return o.getRoot().__preset_select && r.isModified() && pe(o.getRoot(), !0), e;
          },
          r.setValue
        );
      })(e, l, o),
  ...
  (he.toggleHide = function() {
    ...
    A.bind(window, "keydown", he._keydownHandler, !1),
    _.extend(he.prototype, {
      add: function(e, t) {
        return be(this, e, t, { factoryArgs: Array.prototype.slice.call(arguments, 2) });
      },
      addColor: function(e, t) {
        return be(this, e, t, { color: !0 });
      },
      addGradient: function(e, t) {
        return be(this, e, t, { gradient: !0, factoryArgs: Array.prototype.slice.call(arguments, 2) });
      },
      remove: function(e) {
      ...
      destroy: function() {
        ...
        _.each(this.__folders, function(e, t) {
          ...
          this.autoPlace && ae.removeChild(this.domElement),
          A.unbind(window, "keydown", he._keydownHandler, !1),
        ...
        if (t.scrollable) {
          ...
          _.each(t.__ul.childNodes, function(e) {
            ...
            window.innerHeight - e - 20 < n
              ? (A.addClass(t.domElement, he.CLASS_TOO_TALL),
                (t.__ul.style.height = window.innerHeight - e - 20 + "px"))
              : (A.removeClass(t.domElement, he.CLASS_TOO_TALL), (t.__ul.style.height = "auto"));
        }
        t.__resize_handle &&
          _.defer(function() {
      ...
      remember: function() {
        ...
        _.each(Array.prototype.slice.call(arguments), function(e) {
            ...
            (function(n) {
              ...
              if (
                ...
                (document.getElementById("dg-save-locally").style.display = "block"),
                  "true" === localStorage.getItem(ve(n, "isLocal")) && d.setAttribute("checked", "checked"),
                  ye(n, l),
                  A.bind(d, "change", function() {
                    (n.useLocalStorage = !n.useLocalStorage), ye(n, l);
                  });
              }
              ...
              A.bind(c, "keydown", function(e) {
                ...
                A.bind(t, "click", function() {
                  (c.innerHTML = JSON.stringify(n.getSaveObject(), void 0, 2)), se.show(), c.focus(), c.select();
                }),
          ...
          this.autoPlace && we(this, this.width);
      },
      getRoot: function() {
      ...
      getSaveObject: function() {
        ...
        return (
          ...
          0 < this.__rememberedObjects.length &&
            ((n.preset = this.preset), n.remembered || (n.remembered = {}), (n.remembered[this.preset] = Ee(this))),
          (n.folders = {}),
          _.each(this.__folders, function(e, t) {
      ...
      save: function() {
        this.load.remembered || (this.load.remembered = {}),
          (this.load.remembered[this.preset] = Ee(this)),
          pe(this, !1),
          this.saveToLocalStorageIfPossible();
      },
      saveAs: function(e) {
        this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[le] = Ee(this, !0))),
          (this.load.remembered[e] = Ee(this)),
          (this.preset = e),
          ge(this, e, !0),
          this.saveToLocalStorageIfPossible();
      },
      revert: function(t) {
        ...
        _.each(
          this.__controllers,
          function(e) {
            this.getRoot().load.remembered ? me(t || this.getRoot(), e) : e.setValue(e.initialValue, !0),
  ...
  var Ce = { Color: f, math: u, interpret: h },
    xe = {
      Controller: g,
      BooleanController: O,
      OptionController: T,
    ...
    ke = { GUI: he },
    Ae = he,
    Oe = { color: Ce, controllers: xe, dom: Se, gui: ke, GUI: Ae };
  (e.GUI = Ae),
    (e.color = Ce),
    (e.controllers = xe),
    (e.default = Oe),
