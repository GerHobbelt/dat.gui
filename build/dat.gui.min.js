...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? t(exports, require("wsgif"))
    : "function" == typeof define && define.amd
    ? define(["exports", "wsgif"], t)
    : t(((e = e || self).dat = {}), e.SuperGif);
})(this, function (t, u) {
  "use strict";
  function n(e, t) {
        ...
        if (e.litmus(n))
          return (
            m.each(e.conversions, function (e, t) {
              if (((a = e.read(n)), !1 === r && !1 !== a))
                return ((r = a).conversionName = t), (a.conversion = e), m.BREAK;
            }),
            m.BREAK
          );
      }),
  ...
  var a,
    ...
    _ = {
      ...
      rgb_to_hsv: function (e, t, n) {
        ...
        return 0 === s
          ? { h: NaN, s: 0, v: 0 }
          : ((i = e === s ? (t - n) / a : t === s ? 2 + (n - e) / a : 4 + (e - t) / a),
            (i /= 6) < 0 && (i += 1),
            { h: 360 * i, s: a / s, v: s / 255 });
      },
    ...
    f =
      (((d = h.prototype).toString = function () {
        return n(this);
      }),
  ...
  (f.recalculateRGB = function (e, t, n) {
    if ("HEX" === e.__state.space) e.__state[t] = _.component_from_hex(e.__state.hex, n);
    else {
      if ("HSV" !== e.__state.space) throw new Error("Corrupted color state");
      m.extend(e.__state, _.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v));
    }
  }),
    ...
    Object.defineProperty(f.prototype, "hex", {
      get: function () {
        return (
          "HEX" !== !this.__state.space && (this.__state.hex = _.rgb_to_hex(this.r, this.g, this.b)), this.__state.hex
        );
      },
      set: function (e) {
  ...
  var b,
    y =
      ...
      (b.isModified = function () {
        return this.initialValue !== this.getValue();
      }),
      (b.transform = function (e, t) {
        return (
          void 0 === e &&
            (e = function (e) {
              return e;
      ...
      (b.borderColor = function (e) {
        return (this.__li.style.borderLeftColor = e), this;
      }),
      (b.borderWidth = function (e) {
  ...
  var A,
    L = {
      ...
      fakeEvent: function (e, t, n, i) {
        ...
        m.defaults(a, i), e.dispatchEvent(a);
      },
      bind: function (e, t, n, i, o) {
        ...
        return (
          e.addEventListener
            ? ((s = m.supportsPassive() ? { capture: a, passive: r } : a), e.addEventListener(t, n, s))
      ...
      unbind: function (e, t, n, i) {
        var o = i || !1;
        return e.removeEventListener ? e.removeEventListener(t, n, o) : e.detachEvent && e.detachEvent("on" + t, n), L;
      },
    ...
    O = (function (r) {
      ...
      return (
        (t.setValue = function (e, t) {
          ...
          var n = r.prototype.setValue.call(this, e, t);
          return this.__onFinishChange && !t && this.__onFinishChange.call(this, this.getValue()), n;
        }),
        (t.updateDisplay = function () {
          return L.isActive(this.__select) && !this.forceUpdateDisplay
            ? this
            : ((this.__select.value = this.getValue()), r.prototype.updateDisplay.call(this));
        }),
        e
      );
    })(y),
    V =
      ...
      (N.prototype.updateDisplay = function () {
        return L.isActive(this.__input) || (this.__input.value = this.getValue()), A.prototype.updateDisplay.call(this);
      }),
      N);
  function N(e, t) {
    ...
    return (
      ...
      L.bind(n.__input, "keyup", o, !1, !0),
      L.bind(n.__input, "change", o, !1, !0),
      L.bind(
        n.__input,
        "blur",
        function () {
    ...
    return (
      (t.setValue = function (e, t) {
        ...
        return (
          ...
          s.prototype.setValue.call(this, n, t)
        );
      }),
      (t.min = function (e) {
          ...
          return (
            (this.__input.value = this.__truncationSuspended
              ...
              : ((e = this.getValue()),
                (t = this.__precision),
                (n = Math.pow(10, t)),
                Math.round(e * n) / n + this.__suffix)),
            I.prototype.updateDisplay.call(this)
          );
      }),
      D);
  function D(e, t, n) {
    var i = I.call(this, e, t, n) || this,
      o = n || {};
    ...
    function d() {
      L.unbind(window, "mousemove", l), L.unbind(window, "mouseup", d), r();
    }
    return (
      ...
      L.bind(i.__up, "mousedown", function () {
        a.setValue(a.getValue() + a.__impliedStep);
      }),
      L.bind(i.__down, "mousedown", function () {
        a.setValue(a.getValue() - a.__impliedStep);
      }),
      L.bind(
        i.__input,
        "change",
        function () {
          var e = a.__input.value;
          n && a.__suffix && (e = e.replace(a.__suffix, ""));
          var t = parseFloat(e);
          m.isNaN(t) || a._readonly || a.setValue(t);
        },
        !1,
        !0
      ),
      ...
      L.bind(
        ...
        "mousedown",
        function (e) {
          L.bind(window, "mousemove", l, !1, !0), L.bind(window, "mouseup", d, !1, !0), (s = e.clientY);
        },
        !1,
        !0
      ),
      L.bind(i.__input, "wheel", function (e) {
        e.preventDefault();
        var t = -e.deltaY >> 10 || 1;
      ...
      L.bind(
        ...
        function (e) {
          switch (e.keyCode) {
            case 13:
              (a.__truncationSuspended = !0), this.blur(), (a.__truncationSuspended = !1), r();
              break;
            case 38:
              a.setValue(a.getValue() + a.__impliedStep);
              break;
  ...
  var F,
    M =
      (C(G, (F = B)),
      (G.prototype.updateDisplay = function () {
        if (this.__input !== document.activeElement) {
      ...
      G);
  function G(t, n, i, o, s) {
    var a = F.call(this, t, n, { min: i, max: o, step: s }) || this,
      r = E(a);
    function l(e) {
      d(e.clientX);
    }
    function d() {
      var t,
        ...
        o,
        s,
        a = r.__background.getBoundingClientRect();
      r._readonly ||
        r.setValue(
          ((t = e.clientX),
          (n = a.left),
    ...
    function c(e) {
      for (var t = e.changedTouches, n = 0; n < t.length; n++)
        t[n].identifier === r.__activeTouch.identifier && d(t[n].clientX);
    }
    function _() {
      L.unbind(window, "touchmove", c),
        L.unbind(window, "touchend", _),
        (r.__activeTouch = null),
        r.__onFinishChange && r.__onFinishChange.call(r, r.getValue());
    }
    return (
      ...
      L.bind(a.__background, "mousedown", function (e) {
        document.activeElement.blur(), L.bind(window, "mousemove", l), L.bind(window, "mouseup", u, !1, !0), l(e);
      }),
      L.bind(
        a.__background,
        "touchstart",
        function (e) {
          ...
          document.activeElement.blur(),
            L.bind(window, "touchmove", c, !1, !0),
            L.bind(window, "touchend", _, !1, !0),
            (r.__activeTouch = e.targetTouches[0]),
            c(e);
        },
        !1,
        !0
      ),
      L.bind(a.__background, "wheel", function (e) {
        e.preventDefault();
        var t = -e.deltaY >> 10 || 1;
  ...
  var j,
    P =
      ...
      U);
  function U(e, t, n) {
    var i = j.call(this, e, t) || this,
      o = E(i);
    return (
      (i.__button = document.createElement("div")),
      (i.__button.innerHTML = void 0 === n ? "Fire" : n),
      L.bind(i.__button, "click", function (e) {
        return (
          e.preventDefault(),
          o.fire(),
          L.addClass(o.__button.parentElement.parentElement.parentElement, "function--active"),
          setTimeout(function () {
            L.removeClass(o.__button.parentElement.parentElement.parentElement, "function--active");
          }, 100),
          !1
        );
      }),
      L.addClass(i.__button, "button"),
  ...
  function K(e, t, n, i, o) {
    var s = z.call(this, e, t) || this,
      a = E(s);
    (s.__button = document.createElement("div")),
      (s.__button.innerHTML = void 0 === n ? "Fire" : n),
      L.bind(s.__button, "click", function (e) {
        return e.preventDefault(), a.fire(), !1;
      }),
      L.addClass(s.__button, "button");
    var r = 2 * i;
    return (
      (s.__button.style.paddingLeft = r.toString() + "em"), (s.property = o), s.domElement.appendChild(s.__button), s
    );
  }
  var Y,
    W =
      (C(J, (Y = y)),
      (J.prototype.updateDisplay = function () {
        var t,
          n = p(this.getValue());
        !1 !== n &&
          ((t = !1),
      ...
      J);
  function J(e, t) {
    var n = Y.call(this, e, t) || this;
    (n.__color = new f(n.getValue())), (n.__temp = new f(0));
    var r = E(n);
    (n.domElement = document.createElement("div")),
      L.makeSelectable(n.domElement, !1),
    ...
    function s(e) {
      _(e),
        L.bind(window, "mousemove", _),
        L.bind(window, "touchmove", _),
        L.bind(window, "mouseup", l, !1, !0),
        L.bind(window, "touchend", l, !1, !0);
    }
    function a(e) {
      h(e),
        L.bind(window, "mousemove", h),
        L.bind(window, "touchmove", h),
        L.bind(window, "mouseup", d, !1, !0),
        L.bind(window, "touchend", d, !1, !0);
    }
    function l() {
      L.unbind(window, "mousemove", _),
        L.unbind(window, "touchmove", _),
    ...
    function h(e) {
      ...
      return 1 < n ? (n = 1) : n < 0 && (n = 0), (r.__color.h = 360 * n), r.setValue(r.__color.toOriginal()), !1;
    }
    return (
      ...
      L.bind(n.__saturation_field, "mousedown", s),
      L.bind(n.__saturation_field, "touchstart", s),
      L.bind(n.__field_knob, "mousedown", s),
      L.bind(n.__field_knob, "touchstart", s),
      L.bind(n.__hue_field, "mousedown", a),
      L.bind(n.__hue_field, "touchstart", a),
  ...
  function ee(e, t) {
    ...
    return (
      ...
      L.bind(n.__input, "change", function (e) {
  ...
  function te(n, i, o) {
    ...
    return (
      (_.font = "bold " + 9 * a + "px Helvetica,Arial,sans-serif"),
      (_.textBaseline = "top"),
      (_.fillStyle = i),
      _.fillRect(0, 0, e, t),
      (_.fillStyle = n),
      ...
      _.fillRect(r, l, d, u),
      {
        ...
        update: function (e, t) {
          (_.globalAlpha = 1),
            (_.fillStyle = n),
            _.drawImage(c, r + a, l, d - a, u, r, l, d - a, u),
            _.fillRect(r + d - a, l, a, u),
            (_.fillStyle = i),
            (_.globalAlpha = 0.9),
            _.fillRect(r + d - a, l, a, s((1 - e / t) * u)),
            "line" === o && _.fillRect(r + d - a, s((1 - e / t) * u) + a + 3, a, s((e / t) * u));
        },
      }
    );
  }
  var ne,
    ie =
      (C(oe, (ne = y)),
      (oe.prototype.updateDisplay = function () {
        var e = this.getValue();
        return (
          ...
          (this.prevValue = e),
          ne.prototype.updateDisplay.call(this)
        );
      }),
      oe);
  function oe(e, t, n) {
    var i = ne.call(this, e, t) || this;
    return (
      (i.max = n.max),
      (i.period = n.period),
      (i.prevValue = i.getValue()),
      (i.lastUpdate = Date.now()),
      (i.__panel = new te(n.fgColor, n.bgColor, n.type)),
  ...
  var se,
    ae = (C(re, (se = y)), re);
  function re(e, t) {
    var n = se.call(this, e, t) || this;
    return e.constructor(E(n)), n;
  }
  ...
  var le,
    de = (function (d) {
      function e(e, t, n) {
        ...
        return (
          (i = n.defaults ? ((s = n.disableVideo), n.defaults) : n),
          (o.__controlContainer = document.createElement("div")),
          L.addClass(o.__controlContainer, "image-picker"),
          (o.videoStreams = []),
          (o.__selectedInputContainer = o.__controlContainer.appendChild(document.createElement("div"))),
          L.addClass(o.__selectedInputContainer, "selected-image"),
          (o.__swatches = o.__controlContainer.appendChild(document.createElement("div"))),
          L.addClass(o.__swatches, "image-swatches"),
          (o.__img = o.__selectedInputContainer.appendChild(document.createElement("img"))),
          (o.__img.crossOrigin = "anonymous"),
          (o.__video = o.__selectedInputContainer.appendChild(document.createElement("video"))),
          (o.__input = o.__controlContainer.appendChild(document.createElement("input"))),
          (o.__swatchButtons = o.__swatches.appendChild(document.createElement("div"))),
          L.addClass(o.__swatchButtons, "swatch-buttons"),
          (o.__swatchImages = o.__swatches.appendChild(document.createElement("div"))),
          (o.__disableVideo = s),
          L.addClass(o.__swatchImages, "swatch-images"),
          (o.__useCamera = navigator.getUserMedia && !s),
          o.__useCamera &&
            ((o.__camera = o.__swatchButtons.appendChild(document.createElement("div"))),
            (o.__cameraTitle = o.__camera.appendChild(document.createElement("span"))),
            (o.__cameraTitle.innerHTML = "Video"),
            (o.__cameraIcon = o.__camera.appendChild(document.createElement("div"))),
            L.addClass(o.__cameraIcon, "camera-icon"),
            L.addClass(o.__camera, "camera-button")),
          (o.__plus = o.__swatchButtons.appendChild(document.createElement("div"))),
          (o.__plusTitle = o.__plus.appendChild(document.createElement("span"))),
          (o.__plusTitle.innerHTML = "Image"),
          (o.__plusIcon = o.__plus.appendChild(document.createElement("div"))),
          L.addClass(o.__plusIcon, "new-image-icon"),
          L.addClass(o.__plus, "new-image-button"),
          i.forEach(function (e) {
            o.addSwatch(e.src, e.videoSrc);
          }),
          (o.__video.className = o.__img.className = "content"),
          (o.__video.crossOrigin = "anonymous"),
          o.__video.setAttribute("playsinline", !0),
          (o.__input.type = "file"),
          (o.__gifImg = o.__selectedInputContainer.appendChild(document.createElement("img"))),
          (o.__gifImg.crossOrigin = "anonymous"),
          L.addClass(o.__gifImg, "content gif-img"),
          (o.__glGif = new u({ gif: o.__gifImg })),
          (o.__gifNeedsInitializing = !0),
          o.initializeValue(),
          o.__useCamera &&
            L.bind(
              o.__camera,
          ...
          L.bind(o.__img, "dragover", a.bind(E(o))),
          L.bind(o.__img, "dragleave", r.bind(E(o))),
          L.bind(o.__img, "drop", l.bind(E(o))),
          L.bind(o.__video, "dragover", a.bind(E(o))),
          L.bind(o.__video, "dragleave", r.bind(E(o))),
          L.bind(o.__video, "drop", l.bind(E(o))),
          o.domElement.appendChild(o.__controlContainer),
          o
        );
      }
      C(e, d);
      ...
      return (
        ...
        (t.parseFile = function (e) {
          var t,
            n,
            i = e.type.split("/")[0];
          this.__glGif && this.__glGif.pause(),
            "image" === i
              ? ((t = e.urlOverride || URL.createObjectURL(e)),
                (n = "gif" === e.type.split("/")[1] || e.animatedOverride),
                !this.__disableVideo && n
                  ? this.__gifNeedsInitializing
                    ? this.setImage(t, !0)
                    : this.setValue({ url: t, type: "gif", domElement: this.__glGif.get_canvas() })
                  : n || (this.setValue({ url: t, type: "image", domElement: this.__img }), this.setImage(t, !1)))
              : this.__disableVideo ||
                "video" !== i ||
    ...
    ue =
      (C(ce, (le = y)),
      (ce.prototype.updateDisplay = function () {
        for (var e = 0; e < this.__inputs.length; e++) if (L.isActive(this.__inputs[e])) return;
        var o = this;
        function s(n) {
          for (var e = 0; e < o.__inputs.length; e++)
            !(function (t) {
              var e;
              o.__inputs[t].parentElement === n.target.parentElement &&
                ((e = o.getValue().filter(function (e) {
        ...
        this.__inputs.forEach(function (e) {
          ...
          this.getValue().forEach(function (e) {
            ...
            L.addClass(t, "array-input");
            var n = document.createElement("input");
            t.appendChild(n), n.setAttribute("type", "text"), (n.value = e);
            var i = document.createElement("span");
            (i.innerHTML = "&nbsp;"),
              L.addClass(i, "remove-icon"),
              t.appendChild(i),
              L.bind(i, "click", s),
              L.bind(n, "keyup", a),
              L.bind(n, "change", a),
              L.bind(n, "blur", r),
              L.bind(n, "keydown", function (e) {
                13 === e.keyCode && this.blur();
              }),
  ...
  function ce(e, t) {
    ...
    return (
      ...
      L.bind(n.__new, "keydown", function (e) {
  ...
  var he,
    pe =
      (C(fe, (he = y)),
      (fe.prototype.updateDisplay = function () {
        ...
        var e,
          ...
          i =
            ...
            (t = this.__min),
            (n = this.__max),
            [(e[0] - t[0]) / (n[0] - t[0]), (e[1] - t[1]) / (n[1] - t[1])]);
        m.extend(this.__field_knob.style, { marginLeft: 50 * i[0] - 7 + "px", marginTop: 50 * (1 - i[1]) - 7 + "px" }),
          (this.__temp[0] = 1),
          (this.__temp[1] = 1);
      }),
      fe);
  function fe(e, t, n, i) {
    ...
    void 0 === n && (n = [0, 0]),
      void 0 === i && (i = [1, 1]),
      ((o = he.call(this, e, t, { min: n, max: i }) || this).__min = n),
      (o.__max = i),
      (o.__vec = o.getValue()),
      (o.__temp = [0, 0]);
    var u = E(o);
    function s(e) {
      r(e),
        L.bind(window, "mousemove", r),
        L.bind(window, "touchmove", r),
        L.bind(window, "mouseup", a),
        L.bind(window, "touchend", a);
    }
    function a() {
      L.unbind(window, "mousemove", r),
        L.unbind(window, "touchmove", r),
        L.unbind(window, "mouseup", a),
        L.unbind(window, "touchend", a),
        u.__onFinishChange && u.__onFinishChange.call(u, u.__vec);
    }
    function r(e) {
      -1 === e.type.indexOf("touch") && e.preventDefault();
      var t,
        n,
        i,
        o = u.__pos_field.getBoundingClientRect(),
        s = (e.touches && e.touches[0]) || e,
        a = s.clientX,
        r = s.clientY,
        l = (a - o.left) / (o.right - o.left),
        d = 1 - (r - o.top) / (o.bottom - o.top);
      return (
        1 < l ? (l = 1) : l < 0 && (l = 0),
        1 < d ? (d = 1) : d < 0 && (d = 0),
        (u.__vec =
          ((t = [l, d]), (n = u.__min), (i = u.__max), [t[0] * (i[0] - n[0]) + n[0], t[1] * (i[1] - n[1]) + n[1]])),
        u.setValue(u.__vec),
        !1
      );
    }
    return (
      ...
      L.makeSelectable(o.domElement, !1),
      ...
      L.bind(o.__selector, "mousedown", function () {
        L.addClass(this, "drag").bind(window, "mouseup", function () {
          L.removeClass(u.__selector, "drag");
        });
      }),
      L.bind(o.__selector, "touchstart", function () {
        L.addClass(this, "drag").bind(window, "touchend", function () {
          L.removeClass(u.__selector, "drag");
        });
      }),
      m.extend(o.__selector.style, {
        width: "52px",
        height: "52px",
        padding: "3px",
        backgroundColor: "#222",
      ...
      L.bind(o.__pos_field, "mousedown", s),
      L.bind(o.__pos_field, "touchstart", s),
      L.bind(o.__field_knob, "mousedown", s),
      L.bind(o.__field_knob, "touchstart", s),
  ...
  var me,
    ge = function (e, t, n, i, o) {
      var s = e[t];
      return arguments.length <= 3 && null != n && (m.isArray(n) || m.isObject(n))
        ? new O(e, t, n)
        : m.isNumber(s)
        ? m.isNumber(n) && m.isNumber(i)
          ? m.isNumber(o)
            ...
            : new M(e, t, n, i)
          : m.isNumber(o)
          ? new H(e, t, { min: n, max: i, step: o })
          : new H(e, t, { min: n, max: i })
        : (m.isArray(s) && 3 <= s.length && s.length <= 4) ||
          (m.isObject(s) && s.h && s.s && s.v) ||
          (m.isString(s) && "#" === s[0] && (4 === s.length || 7 === s.length))
        ? new W(e, t)
        : m.isArray(s) && 2 === s.length
        ? 3 < arguments.length
          ? new pe(e, t, n, i)
          : new pe(e, t)
        : m.isString(s)
        ? new V(e, t)
        : m.isFunction(s) && void 0 !== n
        ? new X(e, t, "", n || 0, i || "Object")
        : m.isFunction(s)
        ? new P(e, t, "")
        : m.isBoolean(s)
        ? new T(e, t)
  ...
  function be(e, t, n) {
    ...
    return (
      L.addClass(i.domElement, "button-container"),
      (i.__animationMode = null),
      (i.__sineButton = document.createElement("button")),
      L.addClass(i.__sineButton, "sine-button"),
      (i.__sawButton = document.createElement("button")),
      L.addClass(i.__sawButton, "saw-button"),
      L.bind(i.__sawButton, "click", function (e) {
        e.stopPropagation(),
          e.preventDefault(),
          "saw" === o.__animationMode
            ? (a(), L.removeClass(o.__sawButton, "saw-button--activated"))
            : ("sine" === o.__animationMode && L.removeClass(o.__sineButton, "sine-button--activated"),
              (o.__animationMode = "saw"),
              L.addClass(o.__sawButton, "saw-button--activated"),
              s());
      }),
      L.bind(i.__sineButton, "click", function (e) {
        e.stopPropagation(),
          e.preventDefault(),
          "sine" === o.__animationMode
            ? (a(), L.removeClass(o.__sineButton, "sine-button--activated"))
            : ("saw" === o.__animationMode && L.removeClass(o.__sawButton, "saw-button--activated"),
              (o.__animationMode = "sine"),
              L.addClass(o.__sineButton, "sine-button--activated"),
              s());
      }),
      i.updateDisplay(),
  ...
  var ye,
    we =
      ...
      (Ce.prototype.updateDisplay = function () {
        ...
        (i += ")"),
          m.extend(this.__input.style, { background: i, color: "#fff", textShadow: this.__input_textShadow + " #000" });
      }),
      Ce);
  function Ce(e, t, n) {
    var i = ye.call(this, e, t) || this,
      o = E(i);
    function s() {
    ...
    (i.domElement = document.createElement("div")),
      ...
      L.bind(i.__selector, "mousedown", function () {
        L.addClass(this, "drag").bind(window, "mouseup", function () {
          L.removeClass(o.__selector, "drag");
        });
      });
    document.createElement("div");
    m.extend(i.__selector.style, {
      width: "150px",
      padding: "0px",
      lineHeight: "18px",
      backgroundColor: "#222",
    ...
    for (var a = 0; a < n.length; a++) {
      ...
      (r.value = n[a]), (r.width = 150), (r.height = 18);
      var l = r.getContext("2d"),
        d = l.createLinearGradient(0, 0, 150, 0);
      for (var u in n[a]) d.addColorStop(u, n[a][u]);
      L.bind(r, "click", function () {
        o.setValue(this.value), o.updateDisplay(), o.__onFinishChange && o.__onFinishChange.call(o, o.getValue());
      }),
        (l.fillStyle = d),
        l.fillRect(0, 0, r.width, r.height),
        m.extend(r.style, { width: "150px" }),
  ...
  var Ae,
    ...
    He = function t(e) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        (this.__listening = []),
        (i = m.defaults(i, { closeOnTop: !1, autoPlace: !0, width: t.DEFAULT_WIDTH, showCloseButton: !0 })),
        (i = m.defaults(i, { resizable: i.autoPlace, hideable: i.autoPlace })),
        m.isUndefined(i.load) ? (i.load = { preset: Ve }) : i.preset && (i.load.preset = i.preset),
        m.isUndefined(i.parent) && i.hideable && Ie.push(this),
      ...
      var o,
        ...
        l,
        d,
        u = Ne && "true" === window.localStorage.getItem(Pe(0, "isLocal"));
      function c(e) {
        return e.preventDefault(), (r.width += l - e.clientX), r.onResize(), (l = e.clientX), !1;
      }
      function _() {
        L.removeClass(r.__closeButton, He.CLASS_DRAG), L.unbind(window, "mousemove", c), L.unbind(window, "mouseup", _);
      }
      function h(e) {
        return (
          e.preventDefault(),
          (l = e.clientX),
          L.addClass(r.__closeButton, He.CLASS_DRAG),
          L.bind(window, "mousemove", c),
          L.bind(window, "mouseup", _),
          !1
        );
      }
      (this.saveToLocalStorageIfPossible = function () {
        Ne &&
          "true" === window.localStorage.getItem(Pe(0, "isLocal")) &&
          window.localStorage.setItem(Pe(0, "gui"), JSON.stringify(n.getSaveObject()));
      }),
        Object.defineProperties(this, {
          lightTheme: {
            set: function (e) {
              (i.lightTheme = e)
                ? L.addClass(n.domElement, t.CLASS_LIGHT_THEME)
                : L.removeClass(n.domElement, t.CLASS_LIGHT_THEME);
            },
            get: function () {
              return i.lightTheme;
            },
          ...
          showCloseButton: {
            set: function (e) {
              (i.showCloseButton = e)
                ? L.removeClass(n.__closeButton, t.CLASS_DISPLAY_NONE)
          ...
          title: {
            ...
            set: function (e) {
              (i.title = e), o && (m.isString(i.title) ? o.setAttribute("title", i.title) : o.removeAttribute("title"));
            },
          },
          closed: {
            get: function () {
          ...
          useLocalStorage: {
            ...
            set: function (e) {
              Ne &&
                ((u = e)
                  ? L.bind(window, "unload", n.saveToLocalStorageIfPossible)
                  : L.unbind(window, "unload", n.saveToLocalStorageIfPossible),
                window.localStorage.setItem(Pe(0, "isLocal"), e));
            },
          },
        }),
        m.isUndefined(i.parent)
          ? ((this.closed = i.closed || !1),
            ...
            i.lightTheme && L.addClass(this.domElement, t.CLASS_LIGHT_THEME),
            Ne &&
              u &&
              ((n.useLocalStorage = !0), (s = window.localStorage.getItem(Pe(0, "gui"))) && (i.load = JSON.parse(s))),
            (this.__closeButton = document.createElement("div")),
            (this.__closeButton.innerHTML = t.TEXT_CLOSED),
            L.addClass(this.__closeButton, t.CLASS_CLOSE_BUTTON),
            i.closeOnTop
              ? (L.addClass(this.__closeButton, t.CLASS_CLOSE_TOP),
                this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0]))
              : (L.addClass(this.__closeButton, t.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)),
            i.showCloseButton || L.addClass(this.__closeButton, t.CLASS_DISPLAY_NONE),
            L.bind(this.__closeButton, "click", function () {
              n.closed = !n.closed;
            }))
          : (void 0 === i.closed && (i.closed = !0),
            (a = document.createTextNode(i.name)),
            L.addClass(a, "controller-name"),
            (o = De(n, a)),
            m.isString(i.title) && o.setAttribute("title", i.title),
        ...
        this.onResize(),
        i.resizable &&
          (((r = this).__resize_handle = document.createElement("div")),
          m.extend(r.__resize_handle.style, {
            width: "6px",
            marginLeft: "-3px",
            height: "200px",
            cursor: "ew-resize",
          ...
          L.bind(r.__resize_handle, "mousedown", h),
          L.bind(r.__closeButton, "mousedown", h),
          r.domElement.insertBefore(r.__resize_handle, r.domElement.firstElementChild)),
        i.parent ||
          (((d = n.getRoot()).width += 1),
          m.defer(function () {
            --d.width;
  ...
  function Fe(e) {
    L.unbind(window, "resize", e.__resizeHandler),
      e.saveToLocalStorageIfPossible && L.unbind(window, "unload", e.saveToLocalStorageIfPossible);
  }
  function Me(e, t) {
  ...
  function Ge(e, t) {
    ...
    if (-1 !== i) {
      ...
      if (
        ...
        s[i] && void 0 !== s[i][t.property] && ((a = s[i][t.property]), (t.initialValue = a), t.setValue(a, !0));
      }
    }
  }
  function je(e, t, n, i, o) {
    ...
    o.color
      ? (a = new W(t, n))
      : o.gradient
      ? (a = new we(t, n, o.factoryArgs[0]))
      : o.image
      ? (a = new de(t, n, o.factoryArgs[0]))
      : o.plotter
      ? ((a = new ie(t, n, o)), e.listen(a))
      : (a = o.file
          ? new Z(t, n)
          : t instanceof ae && void 0 === n
          ? t
          : t instanceof ae || !o.custom || void 0 !== t[n]
          ? ((s = t instanceof ae ? [n].concat(o.factoryArgs) : [t, n].concat(o.factoryArgs)), ge.apply(e, s))
          : new ae(t, n)),
      o.before instanceof y && (o.before = o.before.__li),
      Ge(e, a),
      L.addClass(a.domElement, "c");
    var r =
    ...
    null !== i ? (r.innerHTML = i) : o.custom || (r.innerHTML = a.property), L.addClass(r, "property-name");
    var l = document.createElement("div");
    l.appendChild(r), l.appendChild(a.domElement);
    var d,
      u,
      c,
      _,
      ...
      f = De(e, l, o.before);
    return (
      L.addClass(f, He.CLASS_CONTROLLER_ROW),
      a instanceof W
        ? L.addClass(f, "color")
        : a instanceof ie
        ? L.addClass(f, "plotter")
        : a instanceof Z
        ? L.addClass(f, "file")
        : a instanceof de
        ? L.addClass(f, "image")
        : L.addClass(f, typeof a.getValue()),
      (d = e),
      (u = f),
      ((c = a).__li = u),
      (c.__gui = d),
      m.extend(c, {
        options: function (e) {
          if (1 < arguments.length) {
            var t = c.__li.nextElementSibling;
            return c.remove(), je(d, c.object, c.property, c.label, { before: t, factoryArgs: [m.toArray(arguments)] });
          }
          if (m.isArray(e) || m.isObject(e)) {
            var n = c.__li.nextElementSibling;
            return c.remove(), je(d, c.object, c.property, c.label, { before: n, factoryArgs: [e] });
          }
        },
        name: function (e) {
          return (c.__li.firstElementChild.firstElementChild.innerHTML = e), c;
        },
        title: function (e) {
          return m.isString(e) ? c.__li.setAttribute("title", e) : c.__li.removeAttribute("title"), c;
        },
        listen: function (e) {
          return (c.forceUpdateDisplay = !!e), c.__gui.listen(c), c;
        },
        remove: function () {
      ...
      c instanceof M
        ? ((_ = new H(c.object, c.property, { min: c.__min, max: c.__max, step: c.__step })),
          m.each(["updateDisplay", "onChange", "onFinishChange", "step", "min", "max"], function (e) {
            var t = c[e],
              n = _[e];
            c[e] = _[e] = function () {
              var e = Array.prototype.slice.call(arguments);
              return n.apply(_, e), t.apply(c, e);
            };
          }),
          L.addClass(u, "has-slider"),
          c.domElement.insertBefore(_.domElement, c.domElement.firstElementChild),
          (h = new ve(c.object, c.property, { min: c.__min, max: c.__max, step: c.__step })),
          m.each(["updateDisplay", "onChange", "onFinishChange", "step"], function (e) {
            var t = c[e],
              n = h[e];
            c[e] = h[e] = function () {
              var e = Array.prototype.slice.call(arguments);
              return n.apply(h, e), t.apply(c, e);
            };
          }),
          L.addClass(u, "has-animate-buttons"),
          c.domElement.insertBefore(h.domElement, c.domElement.firstElementChild))
        : c instanceof H
        ? ((p = function (e) {
            if (m.isNumber(c.__min) && m.isNumber(c.__max)) {
              var t = c.__li.firstElementChild.firstElementChild.innerHTML,
                n = -1 < c.__gui.__listening.indexOf(c);
              c.remove();
              var i = je(d, c.object, c.property, c.label, {
          ...
          (c.min = m.compose(p, c.min)),
          (c.max = m.compose(p, c.max)))
        : c instanceof T
        ? (L.bind(u, "click", function () {
            L.fakeEvent(c.__checkbox, "click");
          }),
          L.bind(c.__checkbox, "click", function (e) {
            e.stopPropagation();
          }))
        : c instanceof P || c instanceof X
        ? (L.bind(u, "click", function () {
            L.fakeEvent(c.__button, "click");
          }),
          L.bind(u, "mouseover", function () {
            L.addClass(c.__button, "hover");
          }),
          L.bind(u, "mouseout", function () {
            L.removeClass(c.__button, "hover");
          }))
        : c instanceof W
        ? (L.addClass(u, "color"),
          (c.updateDisplay = m.compose(function (e) {
            return (u.style.borderLeftColor = c.__color.toHexString()), e;
          }, c.updateDisplay)),
          c.updateDisplay())
        : c instanceof ue
        ? (L.addClass(u, "array"),
          (c.updateDisplay = m.compose(function (e) {
            u.style.height = 26 * (c.__inputs.length + 1) + "px";
          }, c.updateDisplay)),
          c.updateDisplay())
        : c instanceof we
        ? (u.style.borderLeft = "3px solid #2FA1D6")
        : c instanceof pe
        ? L.addClass(u, "vector")
        : c instanceof Z && L.addClass(u, "file"),
      (c.setValue = m.compose(function (e) {
        return d.getRoot().__preset_select && c.isModified() && Me(d.getRoot(), !0), e;
      }, c.setValue)),
    ...
    return (
      m.each(o.__rememberedObjects, function (e, t) {
        ...
        m.each(i, function (e, t) {
          n[t] = s ? e.initialValue : e.getValue();
        }),
          (a[t] = n);
      }),
      a
  ...
  (He.CustomController = ae),
    (He.toggleHide = function () {
      (Be = !Be),
        m.each(Ie, function (e) {
          e.domElement.style.display = Be ? "none" : "";
        });
    }),
    ...
    (He.CLASS_DRAG = "drag"),
    (He.CLASS_DISPLAY_NONE = "display-none"),
    (He.CLASS_LIGHT_THEME = "light-theme"),
    (He.DEFAULT_WIDTH = 245),
    (He.TEXT_CLOSED = "Close View Controls"),
    (He.TEXT_OPEN = "Open View Controls"),
    ...
    L.bind(window, "keydown", He._keydownHandler, !1),
    m.extend(He.prototype, {
      add: function (e, t, n) {
        return je(this, e, t, n, { custom: e instanceof ae, factoryArgs: Array.prototype.slice.call(arguments, 3) });
      },
      openExportWindow: function (e, t) {
        var n;
        m.isUndefined(Ae) &&
          (((Ae = new Se()).domElement.innerHTML = _e),
          (Te = document.getElementById("dg-title")),
          (n = ace.require("ace/mode/json").Mode),
          (Le = ace.edit("dg-new-editor")).setTheme("ace/theme/solarized_dark"),
          Le.session.setMode(new n()),
          Le.setReadOnly(!0)),
          this.autoPlace && Xe(this, this.width),
          (Te.innerHTML = e),
          Le.setValue(JSON.stringify(t, void 0, 2)),
          Ae.show(),
          Le.focus();
      },
      plugins: {
        autocomplete: function (l) {
          var d,
            a,
            u = document,
            ...
            r = l.debounceWaitMs || 0,
            n = t ? "input" : "keyup",
            h = [],
            p = "",
            f = l.minLength,
            m = 0;
          if (!l.input) throw new Error("input undefined");
          var g = l.input;
          function v() {
          ...
          function y() {
            var e;
            m++, (h = []), (p = ""), (d = void 0), (e = c.parentNode) && e.removeChild(c);
          }
          function w() {
            ...
            if (
              (h.forEach(function (t) {
                ...
                t.group &&
                  t.group !== a &&
                  ((a = t.group), (e = o(t.group, p)) && ((e.className += " group"), s.appendChild(e)));
                var n = i(t, p);
                n &&
                  (n.addEventListener("click", function (e) {
                    l.onSelect(t, g), y(), e.preventDefault(), e.stopPropagation();
                  }),
                  t === d && ((n.className += " selected"), "function" == typeof l.onPick && l.onPick(t)),
                  s.appendChild(n));
              }),
              c.appendChild(s),
              h.length < 1)
            ) {
              if (!l.emptyMsg) return void y();
              var r = u.createElement("div");
              (r.className = "empty"), (r.textContent = l.emptyMsg), c.appendChild(r);
            }
            c.parentNode || u.body.appendChild(c),
              b() &&
                ((_.height = "auto"),
                (_.width = g.offsetWidth + "px"),
                (t = (e = g.getBoundingClientRect()).top + g.offsetHeight),
                (n = window.innerHeight - t) < 0 && (n = 0),
                (_.top = t + "px"),
                (_.bottom = ""),
                (_.left = e.left + "px"),
                (_.maxHeight = n + "px"),
                l.customize && l.customize(g, e, c, n)),
              (function () {
                var e = c.getElementsByClassName("selected");
                {
                  var t, n, i, o;
                  0 < e.length &&
                    ((t = e[0]),
                    (n = t.previousElementSibling) &&
                      ...
                      (t = n),
                    t.offsetTop < c.scrollTop
                      ? (c.scrollTop = t.offsetTop)
                      : ((i = t.offsetTop + t.offsetHeight),
                        (o = c.scrollTop + c.offsetHeight) < i && (c.scrollTop += i - o)));
                }
              })();
          }
          function i() {
          ...
          function s(e) {
            e.target !== c ? i() : e.preventDefault();
          }
          function C(e) {
            for (
              var t, n, i = e.which || e.keyCode || 0, o = 0, s = [38, 13, 27, 39, 37, 16, 17, 18, 20, 91, 9];
              o < s.length;
              o++
            ) {
              if (i === s[o]) return;
              ...
              (n = g.value).length >= f
                ? (v(),
                  (a = window.setTimeout(function () {
                    l.fetch(n, function (e) {
                      m === t && e && ((p = n), (d = 0 < (h = e).length ? h[0] : void 0), w());
                    });
                  }, r)))
                : y());
          }
          function E(e) {
            var t = g.value;
            0 === t.length &&
              l.fetch(t, function (e) {
                (p = t), (d = 0 < (h = e).length ? h[0] : void 0), w();
              });
          }
          function x(e) {
            ...
            if (38 === t || 40 === t || 27 === t) {
              ...
              if (27 === t) y();
                ...
                (38 === t
                  ? function () {
                      if (h.length < 1) d = void 0;
                      else if (d === h[0]) d = h[h.length - 1];
                      else
                  ...
                  : function () {
                      if ((h.length < 1 && (d = void 0), d && d !== h[h.length - 1])) {
          ...
          return (
            (c.className = "autocomplete " + (l.className || "")),
            (_.position = "fixed"),
            ...
            u.addEventListener("scroll", s, !0),
            {
              destroy: function () {
                g.removeEventListener("keydown", x),
                  ...
                  u.removeEventListener("scroll", s, !0),
                  v(),
                  y(),
                  m++;
              },
      ...
      addColor: function (e, t, n) {
        return je(this, e, t, n, { color: !0 });
      },
      addPlotter: function (e, t, n, i, o, s, a) {
        return je(this, e, t, {
          plotter: !0,
          max: n || 10,
      ...
      addFile: function (e, t) {
        return je(this, e, t, { file: !0 });
      },
      addCustomController: function (e, t) {
        return je(this, e, t, { custom: !0, factoryArgs: Array.prototype.slice.call(arguments, 2) });
      },
      addGradient: function (e, t, n) {
        return je(this, e, t, n, { gradient: !0, factoryArgs: Array.prototype.slice.call(arguments, 3) });
      },
      addImage: function (e, t, n) {
        return je(this, e, t, n, { factoryArgs: Array.prototype.slice.call(arguments, 3), image: !0 });
      },
      remove: function (e) {
      ...
      destroy: function () {
        ...
        m.each(this.__folders, function (e, t) {
          ...
          L.unbind(window, "keydown", He._keydownHandler, !1),
          Fe(this);
      ...
      addFolder: function (e, t) {
        ...
        var i = new He(n);
        this.__folders[e] = i;
        var o = De(this, i.domElement);
        return L.addClass(o, "folder"), i;
      },
      removeFolder: function (e) {
        ...
        n
          ? (n.close(),
            ...
            this.load && this.load.folders && this.load.folders[n.name] && delete this.load.folders[n.name],
            Fe(n),
            (t = this),
            m.each(n.__folders, function (e) {
              n.removeFolder(e);
            }),
            m.defer(function () {
              t.onResize();
            }))
          : console.error('There is no folder in this GUI by the name "' + e + '"');
      },
      open: function () {
        this.closed = !1;
      },
      ...
      onResize: function () {
        var t,
          n = this.getRoot();
        n.scrollable &&
          (L.getOffset(n.__ul).top,
          (t = 0),
          m.each(n.__ul.childNodes, function (e) {
            (n.autoPlace && e === n.__save_row) || (t += L.getHeight(e));
          }),
          n.domElement.clientHeight - 20 < t
            ? (L.addClass(n.domElement, He.CLASS_TOO_TALL),
              (n.__ul.style.height = n.domElement.clientHeight - 20 + "px"))
            : (L.removeClass(n.domElement, He.CLASS_TOO_TALL), (n.__ul.style.height = "auto"))),
          n.__resize_handle &&
            m.defer(function () {
      ...
      remember: function () {
        if ((m.isUndefined(Ae) && ((Ae = new Se()).domElement.innerHTML = _e), this.parent))
        ...
        m.each(Array.prototype.slice.call(arguments), function (e) {
          0 === t.__rememberedObjects.length &&
            (function (n) {
              ...
              L.addClass(n.domElement, "has-save"),
                n.__ul.insertBefore(e, n.__ul.firstChild),
                L.addClass(e, "save-row");
              var t = document.createElement("span");
              (t.innerHTML = "&nbsp;"), L.addClass(t, "button gears");
              var i = document.createElement("span");
              (i.innerHTML = "Save"), L.addClass(i, "button"), L.addClass(i, "save");
              var o = document.createElement("span");
              (o.innerHTML = "New"), L.addClass(o, "button"), L.addClass(o, "save-as");
              var s = document.createElement("span");
              (s.innerHTML = "Revert"), L.addClass(s, "button"), L.addClass(s, "revert");
              var a = document.createElement("span");
              (a.innerHTML = "Delete"), L.addClass(a, "button"), L.addClass(a, "delete");
              var r = (n.__preset_select = document.createElement("select"));
              n.load && n.load.remembered
                ...
                : Ue(n, Ve, !1);
              {
                ...
                L.bind(r, "change", function () {
                  ...
                  Ne &&
                    ...
                    "true" === window.localStorage.getItem(Pe(0, "isLocal")) && d.setAttribute("checked", "checked"),
                    ze(n, l),
                    L.bind(d, "change", function () {
                      (n.useLocalStorage = !n.useLocalStorage), ze(n, l);
                    }));
              }
              var u = document.getElementById("dg-new-constructor");
              L.bind(u, "keydown", function (e) {
                !e.metaKey || (67 !== e.which && 67 !== e.keyCode) || Ae.hide();
              }),
                L.bind(t, "click", function () {
                  (u.innerHTML = JSON.stringify(n.getSaveObject(), void 0, 2)), Ae.show(), u.focus(), u.select();
                }),
                L.bind(i, "click", function () {
                  n.save();
                }),
          ...
          this.autoPlace && ((this.width += 40), Xe(this, this.width));
      },
      getRoot: function () {
      ...
      getSaveObject: function () {
        ...
        return (
          ...
          0 < this.__rememberedObjects.length &&
            ((n.preset = this.preset), n.remembered || (n.remembered = {}), (n.remembered[this.preset] = Ke(this))),
          (n.folders = {}),
          m.each(this.__folders, function (e, t) {
      ...
      save: function () {
        this.load.remembered || (this.load.remembered = {}),
          (this.load.remembered[this.preset] = Ke(this)),
          Me(this, !1),
          this.saveToLocalStorageIfPossible();
      },
      saveAs: function (e) {
        this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[Ve] = Ke(this, !0))),
          (this.load.remembered[e] = Ke(this)),
          (this.preset = e),
          Ue(this, e, !0),
          this.saveToLocalStorageIfPossible();
      },
      revert: function (t) {
        ...
        m.each(
          this.__controllers,
          function (e) {
            this.getRoot().load.remembered ? Ge(t || this.getRoot(), e) : e.setValue(e.initialValue, !0),
      ...
      deleteSave: function () {
        var e;
        this.preset !== Ve &&
          ((e = this.__preset_select[this.__preset_select.selectedIndex]),
  ...
  var Ye = { Color: f, math: _, interpret: p },
    We = {
      Controller: y,
      BooleanController: T,
      OptionController: O,
      ...
      FunctionController: P,
      TabbedController: X,
      ColorController: W,
      FileController: Z,
      PlotterController: ie,
      CustomController: ae,
      ImageController: de,
      ArrayController: ue,
    },
    Je = { dom: L },
    qe = { GUI: He },
    $e = { color: Ye, controllers: We, dom: Je, gui: qe, GUI: He };
  (t.GUI = He),
    (t.color = Ye),
    (t.controllers = We),
    (t.default = $e),
