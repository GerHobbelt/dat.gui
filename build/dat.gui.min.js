...
!(function(e, t) {
  ...
  function n(e, t, n) {
    Object.defineProperty(e, t, {
      get: function() {
        return "RGB" === this.__state.space ? this.__state[t] : (z.recalculateRGB(this, t, n), this.__state[t]);
      },
      set: function(e) {
        "RGB" !== this.__state.space && (z.recalculateRGB(this, t, n), (this.__state.space = "RGB")),
          (this.__state[t] = e);
      }
    });
  }
  function o(e, t) {
    Object.defineProperty(e, t, {
      get: function() {
        return "HSV" === this.__state.space ? this.__state[t] : (z.recalculateHSV(this), this.__state[t]);
      },
      set: function(e) {
  ...
  function u(e) {
    Y.unbind(window, "resize", e.__resizeHandler),
      e.saveToLocalStorageIfPossible && Y.unbind(window, "unload", e.saveToLocalStorageIfPossible);
  }
  function _(e, t) {
  ...
  function h(e, t, n) {
    if (
      ...
      O.extend(n, {
        options: function(t) {
          if (arguments.length > 1) {
            ...
            return n.remove(), f(e, n.object, n.property, { before: o, factoryArgs: [O.toArray(arguments)] });
          }
        ...
        listen: function(e) {
          return (n.forceUpdateDisplay = !!e), n.__gui.listen(n), n;
        },
        remove: function() {
      ...
      n instanceof K
        ...
        : n instanceof ee &&
          (Y.addClass(t, "color"),
          (n.updateDisplay = O.compose(
            function(e) {
              return (t.style.borderLeftColor = n.__color.toHexString()), e;
            },
            n.updateDisplay
          )),
          n.updateDisplay());
    n.setValue = O.compose(
      function(t) {
  ...
  function f(e, t, n, o) {
    ...
    var i = void 0;
    if (o.color) i = new ee(t, n);
    else if (o.plotter) (i = new re(t, n, o)), e.listen(i);
    else {
      var r = [t, n].concat(o.factoryArgs);
      i = oe.apply(e, r);
    }
    o.before instanceof M && (o.before = o.before.__li), p(e, i), Y.addClass(i.domElement, "c");
    var s = document.createElement("span");
    Y.addClass(s, "property-name"), (s.innerHTML = i.property);
    var a = document.createElement("div");
    a.appendChild(s), a.appendChild(i.domElement);
    var l = c(e, a, o.before);
    return (
      Y.addClass(l, me.CLASS_CONTROLLER_ROW),
      i instanceof ee
        ? Y.addClass(l, "color")
        : i instanceof re
        ? Y.addClass(l, "plotter")
        : Y.addClass(l, P(i.getValue())),
      h(e, l, i),
  ...
  function y(e) {
    ...
    (o.innerHTML = "Save"), Y.addClass(o, "button"), Y.addClass(o, "save");
    var i = document.createElement("span");
    (i.innerHTML = "New"), Y.addClass(i, "button"), Y.addClass(i, "save-as");
    var r = document.createElement("span");
    (r.innerHTML = "Revert"), Y.addClass(r, "button"), Y.addClass(r, "revert");
    var s = document.createElement("span");
    (s.innerHTML = "Delete"), Y.addClass(s, "button"), Y.addClass(s, "delete");
    ...
    if (
      ...
      (document.getElementById("dg-save-locally").style.display = "block"),
        "true" === localStorage.getItem(m(e, "isLocal")) && d.setAttribute("checked", "checked"),
        v(e, l),
        Y.bind(d, "change", function() {
          (e.useLocalStorage = !e.useLocalStorage), v(e, l);
        });
    }
    var c = document.getElementById("dg-new-constructor");
    Y.bind(c, "keydown", function(e) {
      !e.metaKey || (67 !== e.which && 67 !== e.keyCode) || ue.hide();
    }),
      Y.bind(n, "click", function() {
        (c.innerHTML = JSON.stringify(e.getSaveObject(), void 0, 2)), ue.show(), c.focus(), c.select();
      }),
  ...
  function w(e) {
    ...
    function n() {
      Y.removeClass(e.__closeButton, me.CLASS_DRAG), Y.unbind(window, "mousemove", t), Y.unbind(window, "mouseup", n);
    }
    function o(o) {
      return (
        o.preventDefault(),
        (i = o.clientX),
        Y.addClass(e.__closeButton, me.CLASS_DRAG),
        Y.bind(window, "mousemove", t),
        Y.bind(window, "mouseup", n),
        !1
      );
    }
    var i = void 0;
    (e.__resize_handle = document.createElement("div")),
      ...
      Y.bind(e.__resize_handle, "mousedown", o),
      Y.bind(e.__closeButton, "mousedown", o),
  ...
  function E(e, t) {
    var n = {};
    return (
      O.each(e.__rememberedObjects, function(o, i) {
        var r = {},
  ...
  var k = Array.prototype.forEach,
    ...
    O = {
      ...
      each: function(e, t, n) {
        if (e)
          if (k && e.forEach && e.forEach === k) e.forEach(t, n);
      ...
      },
      {
        ...
        conversions: {
          ...
          RGB_OBJ: {
            read: function(e) {
              return (
                !!(O.isNumber(e.r) && O.isNumber(e.g) && O.isNumber(e.b)) && { space: "RGB", r: e.r, g: e.g, b: e.b }
              );
            },
            write: function(e) {
          ...
          HSV_OBJ: {
            read: function(e) {
              return (
                !!(O.isNumber(e.h) && O.isNumber(e.s) && O.isNumber(e.v)) && { space: "HSV", h: e.h, s: e.s, v: e.v }
              );
            },
            write: function(e) {
          ...
          if (t.litmus(e))
            return (
              O.each(t.conversions, function(t, n) {
                if (((R = t.read(e)), !1 === L && !1 !== R))
                  return (L = R), (R.conversionName = n), (R.conversion = t), O.BREAK;
              }),
              O.BREAK
            );
        }),
    ...
    z = (function() {
      function e() {
        if ((V(this, e), (this.__state = B.apply(this, arguments)), !1 === this.__state))
  ...
  (z.recalculateRGB = function(e, t, n) {
    if ("HEX" === e.__state.space) e.__state[t] = H.component_from_hex(e.__state.hex, n);
    else {
      if ("HSV" !== e.__state.space) throw new Error("Corrupted color state");
      O.extend(e.__state, H.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v));
    }
  }),
    (z.recalculateHSV = function(e) {
      var t = H.rgb_to_hsv(e.r, e.g, e.b);
      O.extend(e.__state, { s: t.s, v: t.v }),
    ...
    Object.defineProperty(z.prototype, "hex", {
      get: function() {
        return (
          "HEX" !== !this.__state.space && (this.__state.hex = H.rgb_to_hex(this.r, this.g, this.b)), this.__state.hex
        );
      },
      set: function(e) {
  ...
  var X = /(\d+(\.\d+)?)px/,
    Y = {
      ...
      fakeEvent: function(e, t, n, o) {
        ...
        O.defaults(s, o), e.dispatchEvent(s);
      },
      bind: function(e, t, n, o, i) {
        var r = o || !1,
          s = i || !1;
        if (e.addEventListener) {
          var a = O.supportsPassive() ? { capture: r, passive: s } : r;
    ...
    J = (function(e) {
      function t(e, n, o) {
        V(this, t);
        var i = I(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n)),
          r = o,
          s = i;
        if (((i.__select = document.createElement("select")), O.isArray(r))) {
          var a = {};
          O.each(r, function(e) {
            a[e] = e;
          }),
      ...
      return (
        ...
        D(t, [
          ...
          },
          {
            key: "updateDisplay",
            value: function() {
              return Y.isActive(this.__select) && !this.forceUpdateDisplay
                ? this
    ...
    W = (function(e) {
      function t(e, n) {
        ...
        return (
          ...
          Y.bind(i.__input, "keyup", o, !1, !0),
          Y.bind(i.__input, "change", o, !1, !0),
          Y.bind(
            i.__input,
            "blur",
            function() {
        ...
        D(t, [
          {
            ...
            value: function() {
              return (
                Y.isActive(this.__input) || (this.__input.value = this.getValue()),
                j(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "updateDisplay", this).call(this)
              );
            }
          }
    ...
    q = (function(e) {
      function t(e, n, o) {
        ...
        function s() {
          Y.unbind(window, "mousemove", r), Y.unbind(window, "mouseup", s), i();
        }
        V(this, t);
        var a = I(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, o));
        a.__truncationSuspended = !1;
        var l = a,
          d = (/Firefox/i.test(navigator.userAgent), void 0);
        return (
          (a.__input = document.createElement("input")),
          a.__input.setAttribute("type", "number"),
          Y.bind(
            a.__input,
            "change",
            function() {
              var e = parseFloat(l.__input.value);
              O.isNaN(e) || l.setValue(e);
            },
            !1,
            !0
          ),
          ...
          Y.bind(
            ...
            "mousedown",
            function(e) {
              Y.bind(window, "mousemove", r, !1, !0), Y.bind(window, "mouseup", s, !1, !0), (d = e.clientY);
            },
            !1,
            !0
          ),
          Y.bind(a.__input, "wheel", function(e) {
            e.preventDefault();
            var t = -e.deltaY >> 10 || 1;
            ...
            function(e) {
              switch (e.key) {
                case "Enter":
                  ...
                  break;
                case "ArrowUp":
                  l.setValue(l.getValue() + l.__impliedStep);
                  break;
                case "ArrowDown":
                  l.setValue(l.getValue() - l.__impliedStep);
              }
    ...
    Z = (function(e) {
      function t(e, n, o, i, r) {
        ...
        function l() {
          Y.unbind(window, "mousemove", s),
            Y.unbind(window, "mouseup", l),
        ...
        function c() {
          Y.unbind(window, "touchmove", d),
            Y.unbind(window, "touchend", c),
            _.__onFinishChange && _.__onFinishChange.call(_, _.getValue());
        }
        V(this, t);
        var u = I(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n, { min: o, max: i, step: r })),
          _ = u;
        return (
          (u.__background = document.createElement("div")),
          (u.__foreground = document.createElement("div")),
          Y.bind(u.__background, "mousedown", function(e) {
            document.activeElement.blur(), Y.bind(window, "mousemove", s), Y.bind(window, "mouseup", l, !1, !0), s(e);
          }),
          Y.bind(
            u.__background,
            "touchstart",
            function(e) {
              1 === e.touches.length &&
                (Y.bind(window, "touchmove", d, !1, !0), Y.bind(window, "touchend", c, !1, !0), d(e));
            },
            !1,
            !0
          ),
          Y.bind(u.__background, "wheel", function(e) {
            e.preventDefault();
            var t = -e.deltaY >> 10 || 1;
            _.setValue(_.getValue() + t * _.__impliedStep);
          }),
          Y.addClass(u.__background, "slider"),
          Y.addClass(u.__foreground, "slider-fg"),
          u.updateDisplay(),
    ...
    ee = (function(e) {
      function t(e, n) {
        function o(e) {
          u(e),
            Y.bind(window, "mousemove", u),
            Y.bind(window, "touchmove", u),
            Y.bind(window, "mouseup", r, !1, !0),
            Y.bind(window, "touchend", r, !1, !0);
        }
        function i(e) {
          _(e),
            Y.bind(window, "mousemove", _),
            Y.bind(window, "touchmove", _),
            Y.bind(window, "mouseup", s, !1, !0),
            Y.bind(window, "touchend", s, !1, !0);
        }
        function r() {
          Y.unbind(window, "mousemove", u),
            Y.unbind(window, "touchmove", u),
            Y.unbind(window, "mouseup", r),
            Y.unbind(window, "touchend", r),
            c();
        }
        function s() {
          Y.unbind(window, "mousemove", _),
            Y.unbind(window, "touchmove", _),
            Y.unbind(window, "mouseup", s),
            Y.unbind(window, "touchend", s),
            c();
        }
        function a() {
          var e = B(this.value);
        ...
        V(this, t);
        var h = I(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));
        ...
        return (
          ...
          Y.bind(h.__saturation_field, "mousedown", o),
          Y.bind(h.__saturation_field, "touchstart", o),
          Y.bind(h.__field_knob, "mousedown", o),
          Y.bind(h.__field_knob, "touchstart", o),
              ...
              if (!1 !== e) {
                ...
                O.each(
                  ...
                  function(n) {
                    if (
                      !O.isUndefined(e[n]) &&
                      !O.isUndefined(this.__color.__state[n]) &&
    ...
    oe = function(e, t) {
      ...
      return O.isArray(arguments[2]) || O.isObject(arguments[2])
        ? new J(e, t, arguments[2])
        : O.isNumber(n)
        ? O.isNumber(arguments[2]) && O.isNumber(arguments[3])
          ? O.isNumber(arguments[4])
            ? new Z(e, t, arguments[2], arguments[3], arguments[4])
            : new Z(e, t, arguments[2], arguments[3])
          : O.isNumber(arguments[4])
    ...
    ie = function(e, t, n) {
      ...
      return (
        (_.font = "bold " + 9 * i + "px Helvetica,Arial,sans-serif"),
        (_.textBaseline = "top"),
        (_.fillStyle = t),
        _.fillRect(0, 0, r, s),
        (_.fillStyle = e),
        ...
        _.fillRect(a, l, d, c),
        {
          ...
          update: function(r, s) {
            (_.globalAlpha = 1),
              (_.fillStyle = e),
              _.drawImage(u, a + i, l, d - i, c, a, l, d - i, c),
              _.fillRect(a + d - i, l, i, c),
              (_.fillStyle = t),
              (_.globalAlpha = 0.9),
              _.fillRect(a + d - i, l, i, o((1 - r / s) * c)),
              "line" === n && _.fillRect(a + d - i, o((1 - r / s) * c) + i + 3, i, o((r / s) * c));
          }
        }
      );
    },
    re = (function(e) {
      function t(e, n, o) {
        ...
        return (
          ...
          (i.__panel = new ie(o.fgColor, o.bgColor, o.type)),
              ...
              return (
                this.period < 1 && e !== this.prevValue
                  ...
                  : Date.now() - this.lastUpdate > this.period &&
                    (this.__panel.update(e, this.max),
                    (this.lastUpdate = 2 * Date.now() - this.lastUpdate - this.period)),
                (this.prevValue = e),
                j(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "updateDisplay", this).call(this)
              );
            }
              ...
              var e = this,
                t = function t() {
                  (e.domElement.style.display = "none"),
                    ...
                    Y.unbind(e.domElement, "webkitTransitionEnd", t),
                    Y.unbind(e.domElement, "transitionend", t),
                    Y.unbind(e.domElement, "oTransitionEnd", t);
                };
  ...
  var de = "Default",
    ...
    me = function e(t) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        (this.__listening = []),
        (o = O.defaults(o, { closeOnTop: !1, autoPlace: !0, width: e.DEFAULT_WIDTH })),
        (o = O.defaults(o, { resizable: o.autoPlace, hideable: o.autoPlace })),
        O.isUndefined(o.load) ? (o.load = { preset: de }) : o.preset && (o.load.preset = o.preset),
        O.isUndefined(o.parent) && o.hideable && fe.push(this),
        (o.resizable = O.isUndefined(o.parent) && o.resizable),
        o.autoPlace && O.isUndefined(o.scrollable) && (o.scrollable = !0);
      ...
      if (
        (Object.defineProperties(this, {
          ...
          preset: {
            ...
            set: function(e) {
              n.parent ? (n.getRoot().preset = e) : (o.load.preset = e), C(this), n.revert();
            }
          },
          width: {
            get: function() {
          ...
          closed: {
            ...
            set: function(t) {
              (o.closed = t),
                o.closed ? Y.addClass(n.__ul, e.CLASS_CLOSED) : Y.removeClass(n.__ul, e.CLASS_CLOSED),
                this.onResize(),
          ...
          useLocalStorage: {
            ...
            set: function(e) {
              ce &&
                ((i = e),
                e ? Y.bind(window, "unload", r) : Y.unbind(window, "unload", r),
                localStorage.setItem(m(n, "isLocal"), e));
            }
          }
        }),
        O.isUndefined(o.parent))
      ) {
        if (
          ((this.closed = o.closed || !1),
          Y.addClass(this.domElement, e.CLASS_MAIN),
          Y.makeSelectable(this.domElement, !1),
          ce && i)
        ) {
          n.useLocalStorage = !0;
        ...
        (this.__closeButton = document.createElement("div")),
          ...
          o.closeOnTop
            ? (Y.addClass(this.__closeButton, e.CLASS_CLOSE_TOP),
        ...
        Y.addClass(l, "controller-name"), (s = c(n, l));
        Y.addClass(this.__ul, e.CLASS_CLOSED),
          Y.addClass(s, "title"),
          Y.bind(s, "click", function(e) {
  ...
  (me.toggleHide = function() {
    (pe = !pe),
      O.each(fe, function(e) {
        e.domElement.style.display = pe ? "none" : "";
      });
  }),
    (me.CLASS_AUTO_PLACE = "a"),
    (me.CLASS_AUTO_PLACE_CONTAINER = "ac"),
    (me.CLASS_MAIN = "main"),
    (me.CLASS_CONTROLLER_ROW = "cr"),
    (me.CLASS_TOO_TALL = "taller-than-window"),
    (me.CLASS_CLOSED = "closed"),
    (me.CLASS_CLOSE_BUTTON = "close-button"),
    (me.CLASS_CLOSE_TOP = "close-top"),
    (me.CLASS_CLOSE_BOTTOM = "close-bottom"),
    (me.CLASS_DRAG = "drag"),
    (me.DEFAULT_WIDTH = 245),
    (me.TEXT_CLOSED = "Close Controls"),
    (me.TEXT_OPEN = "Open Controls"),
    (me._keydownHandler = function(e) {
      "text" === document.activeElement.type || (72 !== e.which && 72 !== e.keyCode) || me.toggleHide();
    }),
    Y.bind(window, "keydown", me._keydownHandler, !1),
    O.extend(me.prototype, {
      add: function(e, t) {
      ...
      addPlotter: function(e, t, n, o, i, r, s) {
        return f(this, e, t, {
          plotter: !0,
          max: n || 10,
          period: "number" == typeof o ? o : 500,
          type: i || "line",
          fgColor: r || "#fff",
          bgColor: s || "#000"
        });
      ...
      destroy: function() {
        ...
        O.each(this.__folders, function(t) {
          ...
          Y.unbind(window, "keydown", me._keydownHandler, !1),
          u(this);
      },
        ...
        if (e.scrollable) {
          ...
          O.each(e.__ul.childNodes, function(t) {
            ...
            window.innerHeight - t - 20 < n
              ? (Y.addClass(e.domElement, me.CLASS_TOO_TALL),
                (e.__ul.style.height = window.innerHeight - t - 20 + "px"))
              : (Y.removeClass(e.domElement, me.CLASS_TOO_TALL), (e.__ul.style.height = "auto"));
        }
        e.__resize_handle &&
          O.defer(function() {
      ...
      remember: function() {
        if (
          (O.isUndefined(ue) &&
            ((ue = new ae()).domElement.innerHTML =
        ...
        O.each(Array.prototype.slice.call(arguments), function(t) {
          ...
          this.autoPlace && ((this.width += 40), x(this, this.width));
      },
      getRoot: function() {
      ...
      getSaveObject: function() {
        ...
        return (
          ...
          this.__rememberedObjects.length > 0 &&
            ((e.preset = this.preset), e.remembered || (e.remembered = {}), (e.remembered[this.preset] = E(this))),
          (e.folders = {}),
      ...
      saveAs: function(e) {
        this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[de] = E(this, !0))),
      ...
      deleteSave: function() {
        this.preset !== de &&
          ...
          (delete this.load.remembered[this.preset], (this.preset = b(this)), this.saveToLocalStorageIfPossible());
      },
      listen: function(e) {
  ...
  var ge = { Color: z, math: H, interpret: B },
    be = {
      Controller: M,
      BooleanController: K,
      OptionController: J,
    ...
    ye = { GUI: me },
    we = me,
    xe = { color: ge, controllers: be, dom: ve, gui: ye, GUI: we };
  (e.color = ge),
    (e.controllers = be),
    (e.dom = ve),
    (e.gui = ye),
