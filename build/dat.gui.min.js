!(function(e, t) {
          ...
          return (
            h.each(e.conversions, function(e, t) {
              if (((r = e.read(n)), !1 === a && !1 !== r))
                return ((a = r).conversionName = t), (r.conversion = e), h.BREAK;
            }),
            h.BREAK
          );
      }),
  ...
  var r,
    ...
    p = (((d = _.prototype).toString = function() {
      return t(this);
    }),
  ...
  function F(e, t, n) {
    var i;
    (i = H.call(this, e, t, n) || this).__truncationSuspended = !1;
    var o,
      r = E(i);
    function s() {
  ...
  function I(e, t, n, i, o) {
    var r,
      s = E((r = M.call(this, e, t, { min: n, max: i, step: o }) || this));
    function a(e) {
      e.preventDefault();
    ...
    return (
      ...
      A.bind(r.__background, "mousedown", function(e) {
        document.activeElement.blur(), A.bind(window, "mousemove", a), A.bind(window, "mouseup", l), a(e);
      }),
      A.bind(r.__background, "touchstart", function(e) {
        if (1 !== e.touches.length) return;
        A.bind(window, "touchmove", d), A.bind(window, "touchend", c), d(e);
      }),
  ...
  var U,
    X = (w(K, (U = v)),
    (K.prototype.updateDisplay = function() {
  ...
  function K(e, t) {
    var n;
    ((n = U.call(this, e, t) || this).__color = new p(n.getValue())), (n.__temp = new p(0));
    var a = E(n);
    (n.domElement = document.createElement("div")),
      ...
      A.bind(n.__selector, "mousedown", function() {
        A.addClass(this, "drag").bind(window, "mouseup", function() {
          A.removeClass(a.__selector, "drag");
        });
      }),
    ...
    function o(e) {
      u(e),
        ...
        A.bind(window, "mouseup", s),
        A.bind(window, "touchend", s);
    }
    function r(e) {
      _(e),
    ...
    function s() {
      A.unbind(window, "mousemove", u),
        ...
        A.unbind(window, "mouseup", s),
        A.unbind(window, "touchend", s),
        c();
    }
    function l() {
    ...
    return (
      ...
      A.bind(n.__hue_field, "mousedown", r),
      A.bind(n.__hue_field, "touchstart", r),
  ...
  var te,
    ...
    le = function t(e) {
      ...
      (this.domElement = document.createElement("div")),
        ...
        h.isUndefined(i.load) ? (i.load = { preset: ie }) : i.preset && (i.load.preset = i.preset),
        h.isUndefined(i.parent) && i.hideable && ae.push(this),
        (i.resizable = h.isUndefined(i.parent) && i.resizable),
        i.autoPlace && h.isUndefined(i.scrollable) && (i.scrollable = !0);
      var o,
        r,
        s,
        a = oe && "true" === localStorage.getItem(fe(this, "isLocal"));
      if (
        (Object.defineProperties(this, {
          ...
          useLocalStorage: {
            ...
            set: function(e) {
              oe &&
                ((a = e) ? A.bind(window, "unload", o) : A.unbind(window, "unload", o),
                localStorage.setItem(fe(n, "isLocal"), e));
            }
          }
        }),
        ...
        if (
          ...
          n.useLocalStorage = !0;
          var l = localStorage.getItem(fe(this, "gui"));
        ...
        A.addClass(d, "controller-name"), (r = de(n, d));
        A.addClass(this.__ul, t.CLASS_CLOSED),
          A.addClass(r, "title"),
          A.bind(r, "click", function(e) {
      ...
      i.autoPlace &&
        (h.isUndefined(i.parent) &&
          (re &&
            ...
            A.addClass(ne, "dg"),
            A.addClass(ne, t.CLASS_AUTO_PLACE_CONTAINER),
            document.body.appendChild(ne),
            (re = !1)),
          ne.appendChild(this.domElement),
          A.addClass(this.domElement, t.CLASS_AUTO_PLACE)),
        this.parent || be(n, i.width)),
        ...
        i.resizable &&
          (function(t) {
            ...
            function o() {
              A.removeClass(t.__closeButton, le.CLASS_DRAG),
            ...
            function e(e) {
              return (
                e.preventDefault(),
                (n = e.clientX),
                A.addClass(t.__closeButton, le.CLASS_DRAG),
        ...
        (o = function() {
          oe &&
            "true" === localStorage.getItem(fe(n, "isLocal")) &&
            localStorage.setItem(fe(n, "gui"), JSON.stringify(n.getSaveObject()));
        }),
  ...
  function he(e, t, n, i) {
    ...
    i.before instanceof v && (i.before = i.before.__li), _e(e, o), A.addClass(o.domElement, "c");
    var s = document.createElement("span");
    A.addClass(s, "property-name"), (s.innerHTML = o.property);
    var a = document.createElement("div");
    a.appendChild(s), a.appendChild(o.domElement);
    var l = de(e, a, i.before);
    return (
      A.addClass(l, le.CLASS_CONTROLLER_ROW),
      o instanceof X ? A.addClass(l, "color") : A.addClass(l, typeof o.getValue()),
      (function(o, t, r) {
        if (
          ((r.__li = t),
          (r.__gui = o),
          h.extend(r, {
            options: function(e) {
              if (1 < arguments.length) {
                ...
                return r.remove(), he(o, r.object, r.property, { before: t, factoryArgs: [h.toArray(arguments)] });
              }
              if (h.isArray(e) || h.isObject(e)) {
                var n = r.__li.nextElementSibling;
                return r.remove(), he(o, r.object, r.property, { before: n, factoryArgs: [e] });
              }
            },
            name: function(e) {
          ...
          var e = function(e) {
            if (h.isNumber(r.__min) && h.isNumber(r.__max)) {
              ...
              r.remove();
              var i = he(o, r.object, r.property, {
        ...
        r.setValue = h.compose(
          function(e) {
            return o.getRoot().__preset_select && r.isModified() && ue(o.getRoot(), !0), e;
          },
          r.setValue
        );
      })(e, l, o),
  ...
  (le.toggleHide = function() {
    (se = !se),
      h.each(ae, function(e) {
        e.domElement.style.display = se ? "none" : "";
      });
  }),
    (le.CLASS_AUTO_PLACE = "a"),
    (le.CLASS_AUTO_PLACE_CONTAINER = "ac"),
    (le.CLASS_MAIN = "main"),
    (le.CLASS_CONTROLLER_ROW = "cr"),
    (le.CLASS_TOO_TALL = "taller-than-window"),
    (le.CLASS_CLOSED = "closed"),
    (le.CLASS_CLOSE_BUTTON = "close-button"),
    (le.CLASS_CLOSE_TOP = "close-top"),
    (le.CLASS_CLOSE_BOTTOM = "close-bottom"),
    (le.CLASS_DRAG = "drag"),
    (le.DEFAULT_WIDTH = 245),
    (le.TEXT_CLOSED = "Close Controls"),
    (le.TEXT_OPEN = "Open Controls"),
    (le._keydownHandler = function(e) {
      "text" === document.activeElement.type || (72 !== e.which && 72 !== e.keyCode) || le.toggleHide();
    }),
    A.bind(window, "keydown", le._keydownHandler, !1),
    h.extend(le.prototype, {
      add: function(e, t) {
        return he(this, e, t, { factoryArgs: Array.prototype.slice.call(arguments, 2) });
      },
      ...
      destroy: function() {
        ...
        this.autoPlace && ne.removeChild(this.domElement);
        var t = this;
        h.each(this.__folders, function(e) {
          t.removeFolder(e);
        }),
          A.unbind(window, "keydown", le._keydownHandler, !1),
          ce(this);
      },
        ...
        if (t.scrollable) {
          ...
          h.each(t.__ul.childNodes, function(e) {
            ...
            t.domElement.clientHeight - 20 < n
              ? (A.addClass(t.domElement, le.CLASS_TOO_TALL),
                (t.__ul.style.height = t.domElement.clientHeight - 20 + "px"))
              : (A.removeClass(t.domElement, le.CLASS_TOO_TALL), (t.__ul.style.height = "auto"));
        }
        t.__resize_handle &&
          h.defer(function() {
      ...
      remember: function() {
        ...
        h.each(Array.prototype.slice.call(arguments), function(e) {
            ...
            (function(n) {
              ...
              if (
                ...
                (document.getElementById("dg-save-locally").style.display = "block"),
                  "true" === localStorage.getItem(fe(n, "isLocal")) && l.setAttribute("checked", "checked"),
                  me(n, a),
                  A.bind(l, "change", function() {
                    (n.useLocalStorage = !n.useLocalStorage), me(n, a);
                  });
              }
              var d = document.getElementById("dg-new-constructor");
              A.bind(d, "keydown", function(e) {
                !e.metaKey || (67 !== e.which && 67 !== e.keyCode) || te.hide();
              }),
                A.bind(t, "click", function() {
                  (d.innerHTML = JSON.stringify(n.getSaveObject(), void 0, 2)), te.show(), d.focus(), d.select();
                }),
          ...
          this.autoPlace && be(this, this.width);
      },
      getRoot: function() {
      ...
      getSaveObject: function() {
        ...
        return (
          ...
          0 < this.__rememberedObjects.length &&
            ((n.preset = this.preset), n.remembered || (n.remembered = {}), (n.remembered[this.preset] = ge(this))),
          (n.folders = {}),
      ...
      saveAs: function(e) {
        this.load.remembered || ((this.load.remembered = {}), (this.load.remembered[ie] = ge(this, !0))),
      ...
      revert: function(t) {
        h.each(
          this.__controllers,
          function(e) {
            this.getRoot().load.remembered ? _e(t || this.getRoot(), e) : e.setValue(e.initialValue),
  ...
  var ve = { Color: p, math: u, interpret: f },
    ye = {
      Controller: v,
      BooleanController: O,
      OptionController: T,
    ...
    Ee = { GUI: le },
    Ce = le,
    xe = { color: ve, controllers: ye, dom: we, gui: Ee, GUI: Ce };
  (e.GUI = Ce),
    (e.color = ve),
    (e.controllers = ye),
    (e.default = xe),
