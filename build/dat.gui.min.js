      ...
      },
      {
        ...
        conversions: {
          ...
          RGB_OBJ: {
            read: function(e) {
              return (
                !!(S.isNumber(e.r) && S.isNumber(e.g) && S.isNumber(e.b)) && { space: "RGB", r: e.r, g: e.g, b: e.b }
              );
            },
            write: function(e) {
          ...
          HSV_OBJ: {
            read: function(e) {
              return (
                !!(S.isNumber(e.h) && S.isNumber(e.s) && S.isNumber(e.v)) && { space: "HSV", h: e.h, s: e.s, v: e.v }
              );
            },
            write: function(e) {
  ...
  (he.toggleHide = function() {
    ...
    S.extend(he.prototype, {
      ...
      onResize: function() {
        ...
        if (e.scrollable) {
          var t = 0;
          S.each(e.__ul.childNodes, function(n) {
            (e.autoPlace && n === e.__save_row) || (t += X.getHeight(n));
          }),
            e.domElement.clientHeight - 20 < t
              ? (X.addClass(e.domElement, he.CLASS_TOO_TALL),
                (e.__ul.style.height = e.domElement.clientHeight - 20 + "px"))
